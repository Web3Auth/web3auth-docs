...
Install the Web3Auth's tKey JS package in your Angular project.
...
- [What's a verifier?](/docs/custom-authentication/verifiers)
- [How to create a google verifier?](/docs/custom-authentication/social-providers/google)
