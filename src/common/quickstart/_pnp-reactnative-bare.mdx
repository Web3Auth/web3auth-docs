...
Please note that the v4 react-native-sdk has some breaking changes. For instance, `web3auth.login` is a void Promise, unlike the older versions of the
SDK. Please refer to the [migration guide](/docs/sdk/pnp/react-native/migration) for more
