...
Alongside the `Web3Auth` and `AuthAdapter` you need the above-mentioned packages from
...
and `chainNamespace` are the id and the namespace respectively of the chain you're connecting to.
We've initialized them for EVM for this guide. You can find the list of available providers
[here](/sdk/pnp/web/providers/) to select from.
