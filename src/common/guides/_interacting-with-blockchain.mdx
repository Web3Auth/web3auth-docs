...
blockchain. You can use the [Provider SDKs](/sdk/web/react) to perform RPC Calls to your blockchain.
...
- [Ethereum Provider](/sdk/web/react) gives you the capability of making RPC calls to the EVM
  compatible blockchains.
- [Solana Provider](/sdk/web/react) gives you the capability of making RPC calls to the Solana
  blockchain.
- [XRPL Provider](/sdk/web/react) gives you the capability of making RPC calls to the XRPL
  blockchain.
- If you want to use any other chain except Solana or EVM chains, for ex: Starknet, you can specify
  ...
  [Using other blockchains](/sdk/web/react)
