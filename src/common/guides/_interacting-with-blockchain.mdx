...
- [Ripple Provider](/sdk/helper-sdks/providers/ripple) gives you the capability of making RPC calls to the Ripple blockchain.
- If you want to use any other chain except Solana or EVM chains, for ex: Starknet, you can specify the value of `chainNamespace` field as other in
  the Web3Auth SDK Constructor. Refer to: [Using other blockchains](/sdk/helper-sdks/providers/other)
