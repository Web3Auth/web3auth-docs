...
'tKey' is an abbreviation for Threshold Key, which is responsible for the management of keys and shares produced using threshold cryptography. The
tKey SDK manages private keys by generating shares via Shamir's Secret Sharing scheme.
