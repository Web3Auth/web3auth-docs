...
To login a user in the Web3Auth Plug and Play No Modal SDK, you need to call `connectTo()` function. This function helps you customise the login
process according to your own needs, by taking in a containing the following parameters:
