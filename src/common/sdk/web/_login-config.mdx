...
| `typeOfLogin`            | `TypeOfLogin`   | Choose your type of social login. Select from the list: `google`, `facebook`, `twitter`, `reddit`, `discord`, `twitch`, `apple`, `line`, `github`, `kakao`, `linkedin`, `weibo`, `wechat`, `email_passwordless` | Yes       |
