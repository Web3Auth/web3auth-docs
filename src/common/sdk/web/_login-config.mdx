...
| `typeOfLogin`            | `TypeOfLogin`   | Choose your type of social login. Select from the list: `google`, `facebook`, `twitter`, `reddit`, `discord`, `twitch`, `apple`, `line`, `github`, `kakao`, `linkedin`, `weibo`, `wechat`,`passwordless`, `email_password`, `passwordless`, `jwt`, `webauthn` | Yes       |
| `name`                   | `string`        | Display Name. If not provided, we use the default for openlogin app                                                                                                                                                                                           | Yes       |
