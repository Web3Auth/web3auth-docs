...
| `clientId`              | `string`                                                                     | Client ID for web3auth. Obtain your `clientId` from the [Web3Auth Developer Dashboard](https://dashboard.web3auth.io/).                                                                                                                                                                             | No       |
...
| `sessionTime?`          | `number`                                                                     | sessionTime (in seconds) for idToken issued by Web3Auth for server side verification. Note: max value can be 7 days (86400 \* 7) and min can be 1 day (86400)                                                                                                                                       | Yes      | `86400`                    |
