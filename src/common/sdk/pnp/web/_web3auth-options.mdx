...
| `useCoreKitKey?`                  | Uses Single Factor Auth SDK key with web3auth provider. Default is false.                                                                                                                |
...
| `connectors?`               | [Fetched automatically from Dashboard] Add any additional connectors or their parameters.                |
| `plugins?`                  | Add any additional plugins or their parameters. Eg. Wallet Services Plugin                               |
| `walletServicesConfig?`     | Configure any parameter related to Wallet Services Plugin                                                |
