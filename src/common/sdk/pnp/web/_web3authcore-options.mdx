...
| `storageKey?`         | `enum` - (`session`, `local`)                                                | Setting to "local" will persist the social login session across browser tabs.                                                                                 | No        | `local`   |
...
| `uiConfig?`           | `WhiteLabelData`                                                             | WhiteLabel options for web3auth                                                                                                                               | No        |           |
| `privateKeyProvider?` | `IBaseProvider<string>`                                                      | Private key provider for your chain namespace                                                                                                                 | No        |           |
