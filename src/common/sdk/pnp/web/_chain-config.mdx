...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `chainNamespace`   | The namespace of your preferred chain. Checkout [Providers SDK Reference](/sdk/providers) for understanding RPC Calls. It accepts `ChainNamespaceType` as a value.                                                                                   |
