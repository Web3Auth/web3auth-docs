...
| `mfaSettings`          | This parameter will be used to enable mfa factors and set priority on UI listing. List of factors available backUpShareFactor \| socialFactor \| passwordFactor \| authenticatorFactor                                                                                                                                                                   |
