...
- [EthereumPrivateKeyProvider](/sdk/providers/evm): For Ethereum and EVM compatible chains (secp256k1 private key)
- [SolanaPrivateKeyProvider](/sdk/providers/solana): For Solana Blockchain (ed25519 private key)
