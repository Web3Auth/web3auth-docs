...
In this guide we are not doing any smart contract operation so we are not deploying any account contract and we are just using it for signing pedersen
hashed random string inputs.
