...
const nextjsSteps = {
  ...
  build({ filenames, files, steps, whitelabel, customAuthentication, chain }) {
    ...
    filenames.push("web3auth/nextjs/index.tsx");

    const nextPackageJson = getReactPackageJson(chain);
    newFiles["web3auth/nextjs/package.json"] = replacementAggregator.replaceFileVariable(
      files["web3auth/nextjs/package.json"],
    ...
    newFiles["web3auth/nextjs/custom/App.tsx"] = replacementAggregator.replaceFileVariable(
      files["web3auth/nextjs/custom/App.tsx"],
      "web3auth/nextjs/custom/App.tsx",
      PLACEHOLDERS.RPC_FUNCTIONS,
    ...
    steps.push({
      ...STEPS.buildingApp,
      pointer: replacementAggregator.rangeOffsetEditor({ filename: "web3auth/nextjs/index.tsx", range: "1-11" }),
    });
    ...
    if (customAuthentication === "no") {
      ...
      steps.push(
        {
          ...STEPS.installation,
          pointer: replacementAggregator.rangeOffsetEditor({ filename: "web3auth/nextjs/package.json", range: "6-11" }),
        },
        {
          ...STEPS.registerApp,
          pointer: replacementAggregator.rangeOffsetEditor({ filename: "web3auth/nextjs/App.tsx", range: "8" }),
        }
      );
      if (whitelabel === "yes") {
        steps.push({
          ...STEPS.whiteLabeling,
          pointer: replacementAggregator.rangeOffsetEditor({ filename: "web3auth/nextjs/App.tsx", range: "17-18" }),
        });
      }
      steps.push(
        {
        ...
        },
        {
          ...
          pointer: replacementAggregator.rangeOffsetEditor({
            filename: "web3auth/nextjs/App.tsx",
            range: "33-51",
          }),
        },
        {
          ...STEPS.initialize,
          pointer: replacementAggregator.rangeOffsetEditor({ filename: "web3auth/nextjs/App.tsx", range: "27" }),
        },
        {
    ...
    if (customAuthentication === "yes") {
      filenames.push("web3auth/nextjs/custom/App.tsx");
      ...
      steps.push(
        ...
        {
          ...STEPS.registerApp,
          pointer: replacementAggregator.rangeOffsetEditor({ filename: "web3auth/nextjs/custom/App.tsx", range: "8" }),
        },
        {
          ...STEPS.instantiateCoreSdk,
          pointer: replacementAggregator.rangeOffsetEditor({ filename: "web3auth/nextjs/custom/App.tsx", range: "19" }),
        }
      );
      ...
      if (whitelabel === "yes") {
        steps.push({
          ...STEPS.whiteLabeling,
          pointer: replacementAggregator.rangeOffsetEditor({ filename: "web3auth/nextjs/custom/App.tsx", range: "20-22" }),
        });
      }
      steps.push(
        {
          ...STEPS.subscribe,
          pointer: replacementAggregator.rangeOffsetEditor({
            filename: "web3auth/nextjs/custom/App.tsx",
            range: "31-49",
          }),
        },
        {
          ...STEPS.initialize,
          pointer: replacementAggregator.rangeOffsetEditor({ filename: "web3auth/nextjs/custom/App.tsx", range: "25" }),
        },
        {
          ...STEPS.triggeringLogin,
          pointer: replacementAggregator.rangeOffsetEditor({
    ...
    filenames.push("web3auth/nextjs/global.css");
