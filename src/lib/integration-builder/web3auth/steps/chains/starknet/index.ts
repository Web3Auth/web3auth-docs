...
import * as usingRPCFunctions from "../../frameworks/common/using-rpc-functions.mdx";
...
const chainSteps = {
  ...
  build({ filenames, files, steps, whitelabel, lang, chain }) {
    ...
    if (lang === "react") {
      const reactFileRoute = "web3auth/react-starknet";
    ...
    if (lang === "vue") {
      const vueFileRoute = "web3auth/vue-starknet";
