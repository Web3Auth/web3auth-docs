  ...
  return (
    <>
      <div className={styles.container}>
        <Link className={classNames(styles.card, styles.cardOne)} to="/integration-builder/?b=customauth&lang=HTML">
        ...
        <Link className={classNames(styles.card, styles.cardTwo)} to="/integration-builder/?b=customauth&lang=iOS">
          <p className={styles.headline}>
