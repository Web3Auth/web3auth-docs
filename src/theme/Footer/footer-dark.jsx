import Logo from "@site/static/images/logo-dark.svg";
import Discord from "@site/static/images/social/discord-dark.svg";
import GitHub from "@site/static/images/social/github-dark.svg";
import LinkedIn from "@site/static/images/social/linkedin-dark.svg";
import Medium from "@site/static/images/social/medium-dark.svg";
import Telegram from "@site/static/images/social/telegram-dark.svg";
import Twitter from "@site/static/images/social/twitter-dark.svg";
import YouTube from "@site/static/images/social/youtube-dark.svg";

export default function FooterComponent() {
  return (
    <footer className="footer">
      <div className="container container--fluid">
        <div className="row footer__links" style={{ paddingBottom: 82, borderBottomStyle: "solid", borderBottomColor: "#5C6C7F" }}>
