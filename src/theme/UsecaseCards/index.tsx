    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={classNames(styles.card, styles.cardOne)}>
          ...
          <p>
            Web3Auth is the easiest way for non-tech savvy users to onboard into a wallet, making it a great fit for the NFT ecosystem. It reduces
            friction, and increases conversion
      ...
      <div className={styles.container}>
        <div className={classNames(styles.card, styles.cardOne)}>
          ...
          <p>
            Keplr has been using Web3Auth for one-step registration and logins straight into their Cosmos Extension Wallet. We are thrilled with their
        ...
        <div className={classNames(styles.card, styles.cardOne)}>
          ...
          <p>
            See how Binance Extension Wallet removes seed phrases. Web3Auth has allowed Binance Smart Chain users to seamlessly create and manage
            their extension wallets with their Social Accounts.
          </p>
          <div>
            <a
              className={styles.footer}
