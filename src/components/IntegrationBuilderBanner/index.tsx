    ...
    <div className={styles.container}>
      <div className="row">
        <div className={classNames("col col--7", classNames(styles.cardQuickStart))}>
          <h3 className={styles.headline}>Try building with our Integration Builder</h3>
          <p className={styles.description}>
            A seemless way to quick start your Web3Auth Integration while configuring the components and features of your choice dynamically.
          </p>
