import { AUTH0, DISCORD, FACEBOOK, GOOGLE, JWT, MANDATORY, NONE, OPTIONAL, TWITCH } from "../builder/choices";

export const getLoginCode = (useModal: boolean, customAuth: string, mfa: string) => {
  if (useModal) {
    const code = `
