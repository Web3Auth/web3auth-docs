...
Additionally, while using `Auth0` or `JWT` as the verifier type, you need to provide additional info in the `connectTo` function as highlighted here.

:::

:::info SDK Reference

- [Custom Authentication in Web3Auth Core](/sdk/pnp/web/no-modal/custom-authentication).
