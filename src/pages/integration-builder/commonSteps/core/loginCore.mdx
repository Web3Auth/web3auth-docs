...
Use the `connectTo` function of `web3auth` to navigate user to the login process. Since you're using `@web3auth/core` you have the flexibility of
...
- [`connectTo()` function](/sdk/web/no-modal/usage#logging-in-the-user).
