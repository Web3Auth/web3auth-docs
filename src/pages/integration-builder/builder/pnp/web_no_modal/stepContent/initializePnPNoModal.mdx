...
For initialising Web3Auth PnP No Modal SDK, you need to provide your Client ID, the Web3Auth Network of your project and the configuration of the
...
- [Initialising Web3Auth Modal](/sdk/pnp/web/no-modal/initialize).
