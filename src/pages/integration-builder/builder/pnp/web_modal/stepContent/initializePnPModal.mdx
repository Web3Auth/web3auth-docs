...
For initialising Web3Auth PnP Modal SDK, you need to provide your Client ID, the Web3Auth Network of your project and the configuration of the chain
...
- [Initialising Web3Auth Modal](/sdk/pnp/web/modal/initialize).
