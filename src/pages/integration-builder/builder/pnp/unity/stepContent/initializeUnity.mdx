...
For initialising Web3Auth Unity SDK, you need to provide your Client ID, the Web3Auth Network of your project and the `redirectUrl` for your
...
- [Initialising Web3Auth Unity SDK](/sdk/pnp/unity/initialize).
