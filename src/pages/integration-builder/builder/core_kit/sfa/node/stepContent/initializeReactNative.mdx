...
For initializing Web3Auth Node SDK, you need to provide your Client ID and the Web3Auth Network of your project.

:::tip SDK Reference

- [Initializing SFA Node SDK](/sdk/core-kit/sfa-node/initialize).
