...
This guide is designed to help you quickly integrate a basic instance of Web3Auth Single Factor Auth in your React Native app.
...
The Web3Auth React Native SFA SDK is not compatible with "Expo Go" app. It is compatible only with Custom Dev Client and EAS builds. Please refer to
the [troubleshooting section](/troubleshooting/metro-issues#update-your-metroconfigjs) for more on this.
