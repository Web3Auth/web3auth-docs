...
export default function getSteps(steps, files, replacementAggregator) {
  steps.push(
    ...
    {
      ...STEPS.login,
      pointer: replacementAggregator.highlightRange(hostedFileLinks.SFA_WEB_HTML_SCRIPT_JS, files[hostedFileLinks.SFA_WEB_HTML_SCRIPT_JS], "Login"),
    },
    {
      ...STEPS.getUserInfo,
      pointer: replacementAggregator.highlightRange(
    ...
    {
      ...STEPS.logout,
      pointer: replacementAggregator.highlightRange(hostedFileLinks.SFA_WEB_HTML_SCRIPT_JS, files[hostedFileLinks.SFA_WEB_HTML_SCRIPT_JS], "Logout"),
    },
  );
}
