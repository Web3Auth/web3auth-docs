...
For initializing Web3Auth PnP No Modal SDK, you need to provide your Client ID, the Web3Auth Network of your project and the configuration of the
chain you're looking to connect to. A simple integration for some of the popular blockchains will look like this:
...
- [Initializing Web3Auth](/sdk/pnp/web/no-modal/initialize).
