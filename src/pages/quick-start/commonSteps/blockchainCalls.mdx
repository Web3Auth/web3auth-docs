...
exposed by Web3Auth. For EVM, Solana and XRPL Blockchain Web3Auth exposes special providers for
native integrations.

This example demonstrates the connection for EVM Chains with Web3Auth and utilises the `ethers`,
`viem` & `web3` libraries to make blockchain calls. You can choose the library of your choice and
configure it according the steps given in the respective RPC Files.
