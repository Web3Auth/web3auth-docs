...
type: guide
tags: [multichain, polkadot, evm, ethereum, aptos, cosmos, no-modal, web3auth, react]
...
<SEO
  ...
  description="Learn how to connect to different blockchain using Web3Auth."
  image="https://web3auth.io/docs/content-hub/guides/banners/multichain.png"
  slug="/content-hub/guides/pbp-no-modal-multichain-connection"
/>
...
Please follow our reference for [Ethereum](/connect-blockchain/ethereum/), and similarly use corresponding blockchain libraries that support the
