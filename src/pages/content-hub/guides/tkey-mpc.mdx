...
<SEO
  ...
  slug="/content-hub/guides/tkey-mpc"
/>
...
```bash
npx degit Web3Auth/web3auth-core-kit-examples/mpc-core-kit/tkey-mpc-react-popup-example tkey-mpc && cd tkey-mpc && npm install && npm start
```
