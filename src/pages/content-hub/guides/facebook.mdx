...
```bash
npx degit https://github.com/Web3Auth/web3auth-pnp-examples/web-no-modal-sdk/custom-authentication/facebook-react-core-example w3a-facebook-demo && cd w3a-facebook-demo && npm install && npm run start
```
