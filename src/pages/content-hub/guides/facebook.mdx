...
image: "content-hub/guides/banners/facebook.png"
...
<SEO
  title="Using Facebook with Web3Auth"
  description="Learn how to use Web3Auth Plug and Play No Modal SDK  for Facebook Custom Authentication."
  image="https://web3auth.io/docs/content-hub/guides/banners/facebook.png"
  slug="/content-hub/guides/facebook"
/>
...
```bash
npx degit Web3Auth/web3auth-pnp-examples/web-no-modal-sdk/custom-authentication/facebook-react-core-example w3a-facebook-demo && cd w3a-facebook-demo && npm install && npm run start
```
...
[OpenLogin Provider](/sdk/pnp/web/adapters/openlogin) alongside it to enable Custom Authentication through Facebook Login.
...
[Web3Auth Core Facebook Login Example](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/web-no-modal-sdk/custom-authentication/facebook-react-core-example).
