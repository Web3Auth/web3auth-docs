...
```bash
npx degit Web3Auth/web3auth-pnp-examples/web-no-modal-sdk/server-side-verification/ssv-via-social-nextjs-core-example w3a-ssv-demo && cd w3a-ssv-demo && npm install && npm run dev
```
...
[Web3Auth Server Side Verification - Google Login Example](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/web-no-modal-sdk/server-side-verification/ssv-via-social-nextjs-core-example).
