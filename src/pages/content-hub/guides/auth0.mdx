...
```bash
npx degit https://github.com/Web3Auth/web3auth-pnp-examples/web-no-modal-sdk/custom-authentication/auth0-react-core-example w3a-auth0-demo && cd w3a-auth0-demo && npm install && npm run start
```
