...
Repository: https://github.com/Web3Auth/web3auth-pnp-examples//raw/main/flutter/flutter-example

## Quick Start

```bash
npx degit Web3Auth/web3auth-pnp-examples/flutter/flutter-example w3a-flutter-demo
```
...
[Web3Auth Flutter Example](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/flutter/flutter-example). Check it out and try running it
locally yourself!
