...
<SEO
  ...
  slug="/content-hub/guides/sfa-web-firebase"
/>
...
The `react-firebase-hooks/auth` package provides a convenient `useAuthState` hook for easily managing authentication states in React applications
using Firebase.
