...
image: "content-hub/guides/banners/android-firebase.png"
...
<SEO
  title="Using Firebase with Web3Auth Android SDK"
  description="Learn how to use Web3Auth Android SDK in your Android app with Firebase."
  image="https://web3auth.io/docs/content-hub/guides/banners/android-firebase.png"
  slug="/content-hub/guides/android-firebase"
/>

This guide will cover the basics of how to use the Web3Auth Android SDK in your Android application with Firebase.

**Demo APK:** [Download](https://github.com/Web3Auth/web3auth-pnp-examples//blob/main/android/android-firebase-example/app-debug.apk)

Repository: https://github.com/Web3Auth/web3auth-pnp-examples//raw/main/android/android-firebase-example
...
web3Auth = Web3Auth(
  Web3AuthOptions(
    ...
    network = Network.MAINNET, // pass over the network you want to use (MAINNET, TESTNET, CYAN, AQUA or CELESTE)
...
[Web3Auth Android Firebase Example](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/android/android-firebase-example). Check it out and
try running it locally yourself!

Also, checkout other examples:

- [Using Auth0 Custom Authentication](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/android/android-auth0-example)
- [Using Web3Auth Android SDK)](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/android/android-example)
