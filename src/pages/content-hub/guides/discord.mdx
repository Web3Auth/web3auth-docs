...
```bash
npx degit Web3Auth/web3auth-pnp-examples/web-no-modal-sdk/custom-authentication/discord-react-core-example w3a-discord-demo && cd w3a-discord-demo && npm install && npm run start
```
...
[Web3Auth Core Discord Login Example](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/web-no-modal-sdk/custom-authentication/discord-react-core-example).
