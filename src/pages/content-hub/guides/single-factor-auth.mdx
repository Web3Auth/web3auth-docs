...
```bash
npx degit Web3Auth/web3auth-core-kit-examples/single-factor-auth/react-evm-sfa-example w3a-sfa-react-demo && cd w3a-sfa-react-demo && npm install && npm run start
```
