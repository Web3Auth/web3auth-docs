...
about openloginAdapterParams refer to docs [here](/sdk/pnp/web/openlogin#web3authopenlogin-adapter).
...
[Web3Auth Single Factor Auth Example](https://github.com/Web3Auth/web3auth-core-kit-examples//tree/main/single-factor-auth-web/react-evm-sfa-example).
