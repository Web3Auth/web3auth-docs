...
This guide will cover the basics of how to set up your Web3Auth Plug and Play No Modal SDK and Google Login for custom authentication and provide you
the steps on how to develop a basic web application on the Ethereum blockchain.
...
When integrating Web3Auth Plug and Play No Modal SDK with Google Login the flow looks something like this:
