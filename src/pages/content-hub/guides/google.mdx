...
```bash
npx degit Web3Auth/web3auth-pnp-examples/web-no-modal-sdk/custom-authentication/google-react-core-example w3a-google-demo && cd w3a-google-demo && npm install && npm run start
```
...
[OpenLogin Provider](/sdk/pnp/web/openlogin) alongside it to enable Custom Authentication through Google Login.
...
[Web3Auth Core Google Login Example](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/web-no-modal-sdk/custom-authentication/google-react-core-example).
