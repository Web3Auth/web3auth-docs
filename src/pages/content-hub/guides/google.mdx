...
```bash
npx degit https://github.com/Web3Auth/web3auth-pnp-examples/web-no-modal-sdk/custom-authentication/google-react-core-example w3a-google-demo && cd w3a-google-demo && npm install && npm run start
```
