...
image: "content-hub/guides/banners/android-auth0.png"
...
<SEO
  title="Using Auth0 with Web3Auth Android SDK"
  description="Learn how to use Web3Auth Android SDK in your Android application with Auth0."
  image="https://web3auth.io/docs/content-hub/guides/banners/android-auth0.png"
  slug="/content-hub/guides/android-auth0"
/>

This guide will cover the basics of how to use the Web3Auth Android SDK in your Android application with Auth0.

**Demo APK:** [Download](https://github.com/Web3Auth/web3auth-pnp-examples//blob/main/android/android-auth0-example/app-debug.apk)

Repository: https://github.com/Web3Auth/web3auth-pnp-examples//raw/main/android/android-auth0-example
...
[Web3Auth Android Auth0 Example](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/android/android-auth0-example). Check it out and try
...
- [Using Custom JWT (via Firebase)](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/android/android-firebase-example)
