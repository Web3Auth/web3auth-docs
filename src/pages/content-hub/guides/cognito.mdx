...
```bash
npx degit https://github.com/Web3Auth/web3auth-pnp-examples/web-no-modal-sdk/custom-authentication/cognito-react-core-example w3a-cognito-demo && cd w3a-cognito-demo && npm install && npm run start
```
