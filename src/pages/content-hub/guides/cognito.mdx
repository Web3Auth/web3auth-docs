...
```bash
npx degit Web3Auth/web3auth-pnp-examples/web-no-modal-sdk/custom-authentication/cognito-react-core-example w3a-cognito-demo && cd w3a-cognito-demo && npm install && npm run start
```
...
[OpenLogin Provider](/sdk/pnp/web/openlogin) alongside it to enable Custom Authentication through AWS Cognito.
...
[Web3Auth Cognito Example](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/web-no-modal-sdk/custom-authentication/cognito-react-core-example).
