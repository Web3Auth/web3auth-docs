...
```bash
npx degit https://github.com/Web3Auth/web3auth-pnp-examples/web-no-modal-sdk/custom-authentication/firebase-react-core-example w3a-firebase-demo && cd w3a-firebase-demo && npm install && npm run start
```
