...
```bash
npx degit Web3Auth/web3auth-pnp-examples/web-no-modal-sdk/custom-authentication/firebase-react-core-example w3a-firebase-demo && cd w3a-firebase-demo && npm install && npm run start
```
...
[OpenLogin Provider](/sdk/pnp/web/openlogin) alongside it to enable Custom Authentication through Firebase.
...
[Web3Auth Firebase Example](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/web-no-modal-sdk/custom-authentication/firebase-react-core-example).
