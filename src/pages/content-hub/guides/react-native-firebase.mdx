...
```bash
npx degit https://github.com/Web3Auth/web3auth-pnp-examples/react-native/rn-bare-firebase-example w3a-rn-bare-firebase-demo && cd w3a-rn-bare-firebase-demo && npm install
```
