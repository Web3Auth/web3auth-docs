...
```bash
npx degit https://github.com/Web3Auth/web3auth-pnp-examples/react-native/rn-expo-auth0-example w3a-rn-expo-auth0-demo && cd w3a-rn-expo-auth0-demo && npm install
```
