...
```bash
npx degit https://github.com/Web3Auth/web3auth-pnp-examples/examples/web-modal-sdk/browser-extensions/chrome-extension-web3auth-example w3a-chrome-extension-demo && cd w3a-chrome-extension-demo && npm install && npm run build
```
...
in the [SDKs](/docs/sdk/web) section. The login flow of the user is as follows:
