...
type: guide
tags: [web, "@web3auth/no-modal", "@web3auth/modal", browser extension, chrome, react, ethereum]
...
Repository:
[Google Chrome Browser Extension Example - Modal](https://github.com/Web3Auth/web3auth-pnp-examples/tree/main/web-modal-sdk/browser-extensions/chrome-extension-modal-example)
[Google Chrome Browser Extension Example - No Modal](https://github.com/Web3Auth/web3auth-pnp-examples/tree/main/web-no-modal-sdk/browser-extensions/chrome-extension-no-modal-example)
...
Once logged in you can have all the features Web3Auth provides and along with blockchain libraries like `ethers.js`, `web3.js`, etc you can interact
with the blockchain.
...
Install `@web3auth/no-modal`, `@web3auth/openlogin-adapter`, `@web3auth/ethereum-provider` & `@web3auth/base`

```bash npm2yarn
npm install @web3auth/no-modal @web3auth/base @web3auth/openlogin-adapter @web3auth/ethereum-provider
```
...
To solve this, please have a look at this [troubleshooting page](/troubleshooting/webpack-issues) where we have added the resolution.

### Initialization

Create the Web3Auth instance and configure the Openlogin adapter, in case of no-modal SDK, as per your requirements.
...
// refer to https://web3auth.io/docs/sdk/pnp/web/adapters/openlogin to learn more about configuring the adapter
...
[Web3Auth Modal Browser Extension](https://github.com/Web3Auth/web3auth-pnp-examples/tree/main/web-modal-sdk/browser-extensions/chrome-extension-modal-example)
and
[Web3Auth No Modal Browser Extension](https://github.com/Web3Auth/web3auth-pnp-examples/tree/main/web-no-modal-sdk/browser-extensions/chrome-extension-no-modal-example).
