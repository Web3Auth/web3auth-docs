...
Repository:
[Google Chrome Browser Extension Example](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/web-modal-sdk/browser-extensions/chrome-extension-web3auth-example)

## Quick Start

```bash
npx degit Web3Auth/web3auth-pnp-examples/examples/web-modal-sdk/browser-extensions/chrome-extension-web3auth-example w3a-chrome-extension-demo && cd w3a-chrome-extension-demo && npm install && npm run build
```
...
// refer to https://web3auth.io/docs/sdk/pnp/web/openlogin for learning more about configuring the adapter
...
[Web3Auth Browser Extension](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/web-modal-sdk/browser-extensions/chrome-extension-web3auth-example).
