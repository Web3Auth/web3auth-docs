...
image: "content-hub/guides/banners/react-native-auth0.png"
...
<SEO
  title="Using Auth0 with Web3Auth React Native SDK"
  description="Learn how to use Web3Auth Plug and Play React Native SDK with Auth0"
  image="https://web3auth.io/docs/content-hub/guides/banners/react-native-auth0.png"
  slug="/content-hub/guides/react-native-auth0"
/>
...
[Web3Auth React Native Example](https://github.com/Web3Auth/web3auth-pnp-examples//tree/main/react-native/rn-bare-auth0-example). Check it out and try
