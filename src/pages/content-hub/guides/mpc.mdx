...
```bash
npx degit https://github.com/Web3Auth/web3auth-core-kit-examples/tkey/tkey-mpc-beta-react-popup-example tkey-mpc-beta && cd tkey-mpc-beta && npm install && npm start
```
...
For this guide, we will be talking through the Web3Auth tKey JS MPC (Beta) SDK and showing you a basic example of using it with
`@tkey/default: 8.0.0-alpha.0` package.
