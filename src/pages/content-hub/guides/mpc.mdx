---
title: Using Web3Auth tKey JS MPC SDK
...
```bash
npx degit Web3Auth/web3auth-core-kit-examples/mpc-core-kit/tkey-mpc-react-popup-example tkey-mpc-beta && cd tkey-mpc-beta && npm install && npm start
```
...
For this guide, we will be talking through the Web3Auth tKey JS MPC SDK and showing you a basic example of using it with
...
[Github Example](https://raw.githubusercontent.com/Web3Auth/web3auth-core-kit-examples/main/mpc-core-kit/tkey-mpc-react-popup-example/src/utils.ts) or
the code below.
