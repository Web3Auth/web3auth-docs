...
```bash
npx degit https://github.com/Web3Auth/web3auth-pnp-examples/web-no-modal-sdk/custom-authentication/twitch-react-core-example w3a-twitch-demo && cd w3a-twitch-demo && npm install && npm run start
```
