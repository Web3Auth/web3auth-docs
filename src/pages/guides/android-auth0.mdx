---
title: Using Auth0 with Web3Auth Android SDK
image: "contents/guides/banners/android-auth0.png"
description: Learn how to use Web3Auth Android SDK in your Android application with Auth0.
type: guide
tags: [mobile, android, auth0, whitelabel, custom authentication, dapp share]
date: 17th Jan 2023
...
<SEO
  title="Using Auth0 with Web3Auth Android SDK"
  description="Learn how to use Web3Auth Android SDK in your Android application with Auth0."
  image="https://web3auth.io/docs/contents/guides/banners/android-auth0.png"
  slug="/guides/android"
/>

This guide will cover the basics of how to use the Web3Auth Android SDK in your Android application with Auth0.

**Demo APK:** [Download](https://github.com/Web3Auth/examples/blob/main/android/android-auth0-example/app-debug.apk)

Repository: https://github.com/Web3Auth/examples/raw/main/android/android-auth0-example
...
[Web3Auth Android Auth0 Example](https://github.com/Web3Auth/examples/tree/main/android/android-auth0-example). Check it out and try running it
locally yourself!

Also, checkout other examples:

- [Using Web3Auth Android SDK](https://github.com/Web3Auth/examples/tree/main/android/android-example)
