...
image: "content-hub/guides/banners/"
description: Learn how to integrate Microsoft Github OAuth with Web3auth
type: guide
tags: [microsoft, oauth, decentralized, authentication, github, web3]
...
<SEO
  title="Integrating Microsoft OAuth with Web3Auth for Decentralized Authentication"
  description="Learn how to integrate Microsoft Github OAuth with Web3auth."
  image="https://web3auth.io/docs/content-hub/guides/banners/"
...
Repository: https://github.com/rtomas/microsoft-oauth-for-web3auth
