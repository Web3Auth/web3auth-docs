...
[web3auth tutorial](/docs/authentication/custom-connections/custom-jwt/#how-to-create-jwks). This
file must be located on a public endpoint. To test the example, you will need to modify the file
...
- [Custom JWT providers in Web3auth](/docs/authentication/custom-connections/custom-jwt/)
