...
cd examples/tree/main/web-single-factor-auth/react-evm-sfa-example
npm install
npm run start
```
...
[Web3Auth Single Factor Auth Example](https://github.com/Web3Auth/examples/tree/main/web-single-factor-auth/react-evm-sfa-example). Check it out and
