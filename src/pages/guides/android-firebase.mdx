---
title: Integrating Firebase with Web3Auth PnP Android SDK
...
**Demo APK:**
[Download](https://github.com/Web3Auth/web3auth-pnp-examples/tree/main/android/android-firebase-example/app-debug.apk)
...
Read more about initializing the Android SDK [here](/sdk/mobile/pnp/android/initialize).
...
If you wish you **[add Multi Factor Authentication](/sdk/mobile/pnp/android/mfa)**,
**[use dApp Share](/sdk/mobile/pnp/android/dapp-share)**

- [Multi Factor Authentication](/sdk/mobile/pnp/android/mfa)
- [Using dApp Share](/sdk/mobile/pnp/android/dapp-share)
...
[Web3Auth Android Firebase Example](https://github.com/Web3Auth/web3auth-pnp-examples/tree/main/android/android-firebase-example).
