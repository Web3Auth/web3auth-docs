...
If you have existing users with a Dynamic embedded wallet, you can seamlessly transition them to
Web3Auth while retaining the same account.

:::note

Using the MPC Core Kit is the recommended approach for migrating users from Dynamic embedded wallet
to Web3Auth.
