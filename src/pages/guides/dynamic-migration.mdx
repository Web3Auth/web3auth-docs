...
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Wallet Management      | Dynamic use Turnkey's non-custodial infrastructur which is based on secure enclave storage. It doesn't have MPC TSS support. | Web3Auth supports both SSS and MPC TSS to manage user's private key.                                                                                                                                                |
...
If you are a fan boy of wagmi, we have got your covered. You can use our web3auth-wagmi-connector to
initialize a wagmi client that will seamlessly manage the interaction of your dApp with
