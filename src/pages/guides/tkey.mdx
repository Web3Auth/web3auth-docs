...
```bash
git clone https://github.com/Web3Auth/web3auth-core-kit-examples//tree/main/tkey/tkey-react-example
...
wget https://github.com/Web3Auth/web3auth-core-kit-examples//blob/main/tkey/tkey-react-example/public/serviceworker/sw.js -O public/serviceworker/sw.js
```
...
[examples repository](https://github.com/Web3Auth/web3auth-core-kit-examples//blob/main/tkey/tkey-react-example). Check it out and try running it
locally yourself!
