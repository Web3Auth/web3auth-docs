...
with Firebase and make blockchain calls to get access to user's `account`, fetch `balance`,
...
**[select Curve](/sdk/pnp/flutter/usage#selecting-curve)** for your Android application, read the
...
[Web3Auth Flutter Firebase Example](https://github.com/Web3Auth/web3auth-pnp-examples/tree/main/flutter/flutter-firebase-example).
