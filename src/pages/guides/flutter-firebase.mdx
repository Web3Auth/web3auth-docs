...
[documentation](https://web3auth.io/docs/authentication/custom-connections/firebase).
...
[documentation for Flutter PnP SDK](/docs/sdk/mobile/pnp/flutter/). You can find the code used for
the guide on our
