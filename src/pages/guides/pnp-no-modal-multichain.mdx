---
title: Creat a Chain Agnostic Web3 Wallet with PnP no-modal SDK
...
>
  ...
  <TabItem value="yarn">
    ...
    yarn add @web3auth/base @web3auth/no-modal @web3auth/openlogin-adapter @web3auth/ethereum-provider @web3auth/solana-provider @polkadot/api @polkadot/util-crypto @taquito/signer @taquito/taquito @taquito/utils @tezos-core-tools/crypto-utils @starkware-industries/starkware-crypto-utils web3 ethers
  ...
  <TabItem value="pnpm">
    ...
    pnpm add @web3auth/base @web3auth/no-modal @web3auth/openlogin-adapter @web3auth/ethereum-provider @web3auth/solana-provider @polkadot/api @polkadot/util-crypto @taquito/signer @taquito/taquito @taquito/utils @tezos-core-tools/crypto-utils @starkware-industries/starkware-crypto-utils web3 ethers
...
properly configure the `clientId`, `web3AuthConfig` and `openloginAdapterConfig` objects in the
`config` directory.
