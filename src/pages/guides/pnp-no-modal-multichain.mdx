...
For this guide, we will discuss the [Web3Auth Plug and Play No Modal SDK](/sdk/web/react) and the
different blockchain providers.
...
the [available social logins](https://web3auth.io/docs/sdk/web#loginsettings).
...
- https://web3auth.io/docs/sdk/web/
