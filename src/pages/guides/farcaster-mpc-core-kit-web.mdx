...
Farcaster.
[Follow these steps to setup your Custom Verifier with Web3Auth](/docs/authentication/custom-connections/custom-jwt#set-up-custom-jwt-connection).
`pages/api/login.ts`
...
[private key](/docs/authentication/custom-connections/custom-jwt#generate-private-key) and include
necessary user data that you get from Farcaster.
