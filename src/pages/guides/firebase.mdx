...
<SEO
  title="Using Firebase with Web3Auth"
  description="Learn how to use Web3Auth Plug and Play Core SDK with Firebase. This guide will cover the basics of how to set up your Web3Auth SDK and Firebase for integration and provide you with the links on how to develop a basic web application on the Ethereum blockchain."
