...
This guide is a tutorial to go through the steps required for using solana blockchain in web3auth. To get started, you can follow the code at our
[web3auth-solana-example](https://github.com/Web3Auth/web3auth-solana-example) repository as well.
...
You have completed this tutorial,you can refer to working code of this tutorial [here](https://github.com/Web3Auth/web3auth-solana-example).
