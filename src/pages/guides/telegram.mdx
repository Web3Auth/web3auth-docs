...
3. [Set up a Telegram custom JWT verifier](https://web3auth.io/docs/auth-provider-setup/social-providers/telegram)
...
2. [Custom JWT verifier for Telegram](https://web3auth.io/docs/auth-provider-setup/social-providers/telegram)
