...
2. [Create a JWKS file for your public key used for JWT signing](/docs/auth-provider-setup/byo-jwt-provider/#how-to-convert-pem-to-jwks)
   and host it on a public endpoint.
3. [Set up a Telegram custom JWT verifier](/docs/auth-provider-setup/social-providers/telegram) for
   Telegram on the Web3Auth Dashboard.
