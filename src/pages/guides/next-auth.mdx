...
- [Web3Auth's Project Client ID](https://web3auth.io/docs/dashboard)
- [Google Application](https://web3auth.io/docs/authentication/social-logins/google#create-a-google-app)
- [Web3Auth Google Verifier](https://web3auth.io/docs/authentication/social-logins/google#set-up-google)
