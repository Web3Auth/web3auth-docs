...
image: "contents/guides/banners/react-native-auth0.png"
...
<SEO
  title="Using Auth0 with Web3Auth React Native SDK"
  description="Learn how to use Web3Auth Plug and Play React Native SDK with Auth0"
  image="https://web3auth.io/docs/contents/guides/banners/react-native-auth0.png"
...
Repository: https://github.com/Web3Auth/examples/tree/main/react-native/rn-bare-auth0-example
...
[Web3Auth React Native Example](https://github.com/Web3Auth/examples/tree/main/react-native/rn-bare-auth0-example). Check it out and try running it locally yourself!
