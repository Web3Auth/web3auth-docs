...
For general integrations, [MPC Core Kit](/sdk/core-kit/mpc-core-kit) is the best alternative to be
used.
...
[tKey JS SDK Reference](/sdk/core-kit/tkey) for more details on the conventional functions involved.
