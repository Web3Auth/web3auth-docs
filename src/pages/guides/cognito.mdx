...
<SEO
  ...
  image="https://web3auth.io/docs/contents/guides/banners/cognito.svg"
  slug="/guides/cognito"
/>
...
[Web3Auth Cognito Example](https://github.com/Web3Auth/examples/tree/main/web-core-sdk/custom-authentication/cognito-react-core-example). Check it out
and try running it locally yourself!

## Questions?

Ask us on [Web3Auth's Github Discussion Board](https://github.com/orgs/Web3Auth/discussions?discussions_q=sort%3Atop)
