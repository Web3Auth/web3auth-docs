...
image: "/docs/contents/guides/banners/cognito.svg"
description: Learn how to use Web3Auth with AWS Cognito in your Modern Applications.
type: guide
tags: [ethereum, web3auth, web3auth core, cognito, react]
date: 25th June 2022
...
<head>
  ...
  <meta property="og:image" content="https://web3auth.io/docs/contents/guides/banners/cognito.svg" />
