...
image: "/contents/guides/banners/cognito-banner.png"
description: Learn to use Web3Auth with AWS Cognito.
order: 2
---
...
![AWS Cognito - Implicit Flow](/contents/guides/cognito/cognito-implicit-flow.png)
...
![AWS Cognito - Authorization Code Flow](/contents/guides/cognito/cognito-authz-code-flow.png)
