...
image: "/docs/contents/guides/banners/unity.svg"
...
<SEO
  ...
  image="https://web3auth.io/docs/contents/guides/banners/unity.svg"
  slug="/guides/unity"
/>
...
- Add `{{SCHEMA}}://{YOUR_APP_PACKAGE_NAME}://auth` to **Whitelist URLs** feild of the Web3Auth Dashboard.
...
```csharp title="/Assets/Web3Auth.cs"
using System;
using System.Linq;
...
When connecting, the `login` function takes the LoginParams arguments for the login. See the [LoginParams](/docs/sdk/unity/usage#arguments) for more
details.
...
If you wish you **[add Multi Factor Authentication](/docs/sdk/unity/mfa)**, **[use dApp Share](/docs/sdk/unity/dapp-share)** or
**[select Curve](/docs/sdk/unity/usage#selecting-curve)** for your Unity Game, read the linked documentation.

- [Multi Factor Authentication](/docs/sdk/unity/mfa)
- [Using dApp Share](/docs/sdk/unity/dapp-share)
- [Selecting Curve](/docs/sdk/unity/usage#selecting-curve)
