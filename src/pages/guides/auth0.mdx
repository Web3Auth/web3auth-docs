...
import Auth0GuideCard from "@site/static/contents/guides/banners/auth0-banner.png";
...
<head>
  ...
  <meta property="og:image" content={Auth0GuideCard} />
  ...
  <meta property="og:url" content="https://web3auth.io/docs/guides/auth0" />
