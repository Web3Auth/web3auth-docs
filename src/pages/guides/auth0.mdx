...
image: "/docs/contents/guides/banners/auth0.svg"
description: Learn how to use Web3Auth with Auth0 in your Modern Applications.
type: guide
tags: [ethereum, web3auth, web3auth core, auth0, react]
date: 25th May 2022
...
<head>
  ...
  <meta property="og:image" content="https://web3auth.io/docs/contents/guides/banners/auth0.svg" />
