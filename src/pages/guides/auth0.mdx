...
description: Learn how to use Web3Auth with Auth0 in your Modern Applications.
type: guide
...
[here](https://github.com/Web3Auth/Web3Auth/tree/master/examples/auth0-react-example).
