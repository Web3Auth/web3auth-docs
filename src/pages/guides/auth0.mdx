...
type: guide
tags: [web, "@web3auth/core", auth0, custom authentication, react, ethereum, sms, email, sms passwordless, email passwordless, passwordless]
date: 25th May 2022
...
If you're to use SMS Passwordless, please **[visit here to setup the Lock
Screen of Auth0](https://auth0.com/docs/authenticate/passwordless/implement-login/universal-login)**  from your Auth0 Dashboard.
...
If you're to use Email Passwordless, please **[visit here to setup the Lock
Screen of Auth0](https://auth0.com/docs/authenticate/passwordless/implement-login/universal-login)**  from your Auth0 Dashboard.
...
- Create a Verifier from the **Custom Auth** Section of the [Developer Dashboard](https://dashboard.web3auth.io/) with the following
  configuration:
  ...
  - Click on `Create` button to create your verifier. It may take up to 10-20 minutes to deploy verifier on _testnet_. You'll receive an email once it's
    complete.
...
await web3auth.connectTo(WALLET_ADAPTERS.OPENLOGIN, {
  ...
  extraLoginOptions: {
    ...
    verifierIdField: "sub", // For SMS Passwordless, use "name" as verifierIdField
  },
});
```
