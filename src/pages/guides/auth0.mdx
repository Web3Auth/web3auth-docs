...
For this guide, we will be talking through the [Web3Auth Plug and Play No Modal SDK](/sdk/web/react)
and using the [Auth Adapter](/sdk/web/react) alongside it to enable Custom Authentication through
Auth0.
...
about the other things you can do with Web3Auth, check out our [SDK Reference](/sdk/web/react).
