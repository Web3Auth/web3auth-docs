...
[Web3Auth Plug and Play No Modal SDK](/sdk/web/react) and using the [Auth Adapter](/sdk/web/react)
alongside it to enable Custom Authentication through Facebook Login.
...
about the other things you can do with Web3Auth, checkout our [SDK Reference](/sdk/web/react).
