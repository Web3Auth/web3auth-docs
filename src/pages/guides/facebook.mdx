...
import OpenloginConfigCodeFacebook from "@site/src/common/guides/_auth-config-code-facebook.mdx";
...
more about the other things you can do with Web3Auth, checkout our
...
Openlogin Adapter can connect to the correct verifier and AWS Cognito server.
