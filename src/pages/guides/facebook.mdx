---
title: Using Facebook with Web3Auth Core
image: "/docs/contents/guides/banners/facebook.svg"
description: Learn how to use Web3Auth Core for Facebook Custom Authentication.
type: guide
tags: [ethereum, web3auth, web3auth core, react, facebook]
date: 18th July 2022
...
<head>
  ...
  <meta property="og:image" content="https://web3auth.io/docs/contents/guides/banners/facebook.svg" />
  <meta name="description" content="Learn how to use Web3Auth Core for Facebook Custom Authentication." />
  <meta property="og:title" content="Using Facebook Login with Web3Auth Core" />
  <meta property="og:description" content="Learn how to use Web3Auth Core for Facebook Custom Authentication." />
  <meta property="og:url" content="https://web3auth.io/docs/guides/facebook" />
  <meta name="keywords" content="web3auth, facebook, fb, facebook authentication, authentication, auth, web3" />
</head>
...
cd facebook-core-react-example
npm install
npm run start
```
...
- Create a **Verifier** from the **Custom Auth** Section of the [Web3Auth Developer Dashboard](https://dashboard.web3auth.io/) with following
  ...
  - Paste the **Client ID** from the Facebook App(above) to the `Client ID` field.
...
[Web3Auth Core Facebook Login Example](https://github.com/Web3Auth/examples/tree/main/facebook-core-react-example). Check it out and try running it
locally yourself!
