...
<SEO
  title="Using Facebook with Web3Auth"
  description="Learn how to use Web3Auth Plug and Play Core SDK  for Facebook Custom Authentication."
  image="https://web3auth.io/docs/contents/guides/banners/facebook.svg"
...
[Web3Auth Core Facebook Login Example](https://github.com/Web3Auth/examples/tree/main/web-core-sdk/custom-authentication/facebook-react-core-example).
