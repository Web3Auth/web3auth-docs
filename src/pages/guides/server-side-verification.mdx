...
This guide will cover the basics of how to use Web3Auth's Server Side Verification at your backend to verify the `idToken` received.

**Live Demo:** https://web3auth-ssv-demo.vercel.app

## Quick Start

```bash
git clone https://github.com/Web3Auth/examples.git
cd ssv-nextjs-example
npm install
npm run dev
```
