...
image: "contents/guides/banners/ssv.png"
...
<SEO
  title="Using Server Side Verification with Web3Auth"
  description="Learn how to use Web3Auth Server Side Verification inside a Next.js application."
  image="https://web3auth.io/docs/contents/guides/banners/ssv.png"
...
**[Live Demo](https://rebrand.ly/serversideverification)**

## Quick Start

```bash
git clone https://github.com/Web3Auth/examples.git
cd web-no-modal-sdk/server-side-verification/ssv-via-social-nextjs-core-example
npm install
npm run dev
```
...
[Web3Auth Server Side Verification - Google Login Example](https://github.com/Web3Auth/examples/tree/main/web-no-modal-sdk/server-side-verification/ssv-via-social-nextjs-core-example).
