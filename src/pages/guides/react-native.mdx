...
description: Learn how to use Web3Auth Plug and Play Core SDK in your React Native app
type: guide
...
[Web3Auth React Native Example](https://github.com/Web3Auth/examples/tree/main/react-native/rn-bare-example). Check it out and try running it locally yourself!
