---
title: Learn to integrate Auth0 with Web3Auth SFA React Native SDK
...
type: guide
tags: [core kit, auth0, custom authentication, react native, evm]
...
<SEO
  ...
  image="https://web3auth.io/docs/guides-banners/sfa-auth0.png"
...
integration and provide you with the links on how to develop a basic React Native Expo application
...
Please follow the guide here to
[configure Auth0 for React Native](https://auth0.com/docs/quickstart/native/react-native/00-login).
