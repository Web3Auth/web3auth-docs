...
| Multi-chain support    | Privy as of now only supports secp256k1 curve.                                | Web3Auth is chain agnostic, it supports both secp256k1 and ed25519 curves.                                                                                                                     |
| Multi-platform support | Privy only supports Web, React Native, and Swift.                             | Web3Auth supports multiple platforms, including Web, React Native, Unity, Unreal, Flutter, Swift, and Android. [Checkout documentation for more details](/docs/sdk?product=Plug%20and%20Play). |
...
| Whitelabel             | Privy has limited white-labelling options.                                    | Web3Auth has end to end white-labelling options.                                                                                                                                               |
...
to Web3Auth. We'll cover most scenarios, but if we miss any, please don't hesitate to reach out.
...
If you are were using EVM external wallets previously with Privy, you can simply configure the
`@web3auth/evm-default-adapter` for your Web3Auth instance.
...
The above code snippet is for Web3 Modal SDK, if you are looking No Modal SDK, you can
...
with a Privy embedded wallet, you can seamlessly transition them to Web3Auth while retaining the
same account.
