...
image: "guides/banners/mpc-swift.png"
...
<SEO
  ...
  description="Learn how to use the Web3Auth MPC Swift SDK in your iOS Application."
  image="https://web3auth.io/docs/guides/banners/mpc-swift.png"
  slug="/ios-mpc"
/>

This guide will help you make an iOS application using Web3Auth MPC Swift SDK, covering the basic
...
Service Provider in `tKey` generates a [**Share A**](/sdk/core-kit/tkey), i.e., the private key
