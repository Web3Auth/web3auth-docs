...
<SEO
  title="Using Google with Web3Auth"
  description="Learn how to use Web3Auth Plug and Play Core SDK  for Google Custom Authentication."
  image="https://web3auth.io/docs/contents/guides/banners/google.svg"
  slug="/guides/google"
/>
...
[Web3Auth Core Google Login Example](https://github.com/Web3Auth/examples/tree/main/web-core-sdk/custom-authentication/google-react-core-example).
