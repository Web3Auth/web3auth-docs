---
title: Using Google with Web3Auth Core
image: "/docs/contents/guides/banners/google.svg"
description: Learn how to use Web3Auth Core for Google Custom Authentication.
type: guide
tags: [ethereum, web3auth, web3auth core, react, google]
date: 18th July 2022
...
- Create a **Verifier** from the **Custom Auth** Section of the [Web3Auth Developer Dashboard](https://dashboard.web3auth.io/) with following
  ...
  ![Custom Authentication - Create Google Login Verifier](/contents/guides/cognito/cognito-create-verifier.png)
...
[Web3Auth Cognito Example](https://github.com/Web3Auth/examples/tree/main/google-core-react-example). Check it out and try running it locally
yourself!
