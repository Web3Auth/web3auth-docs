...
import { blockchainMap, featuresMap, languageMap, platformMap, Props } from "../../components/GuidesMaps";
  ...
  return (
    <Layout title="Guides">
      ...
      <header className={styles.header}>
        <h1>Guides</h1>
        <p>Your centralized hub for comprehensive articles covering integration, SDK usage, customization, troubleshooting, and advanced features.</p>
