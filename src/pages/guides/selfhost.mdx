...
The tKey SDK is the underlying SDK used to implement Web3Auth Plug n Play. Hence for Self Hosting, we give you the option to directly to try out our
open source, UI-less SDK, tKey. tKey stands for Threshold Key, which refers to the management keys & shares generated using threshold cryptography.
...
Further, we need to setup the service worker according to our needs of the project. Easiest way to do that is as follows
