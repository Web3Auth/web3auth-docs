...
<SEO
  ...
  slug="/guides/github-oauth-web3auth-integration"
/>
...
Execute `npm run dev`. To initiate the Microsoft OAuth flow, Open your browser to `http://localhost:5005/github/login`
...
```json
{
   ...
   "jwtToken":"eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIs...oWw",
   "ethData":{
