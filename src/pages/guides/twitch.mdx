---
title: Using Twitch with Web3Auth Core
image: "/docs/contents/guides/banners/twitch.svg"
description: Learn how to use Web3Auth Core for Twitch Custom Authentication.
type: guide
tags: [ethereum, web3auth, web3auth core, react, twitch]
date: 18th July 2022
...
<head>
  ...
  <meta property="og:image" content="https://web3auth.io/docs/contents/guides/banners/twitch.svg" />
  <meta name="description" content="Learn how to use Web3Auth Core for Twitch Custom Authentication." />
  <meta property="og:title" content="Using Twitch Login with Web3Auth Core" />
  <meta property="og:description" content="Learn how to use Web3Auth Core for Twitch Custom Authentication." />
  <meta property="og:url" content="https://web3auth.io/docs/guides/twitch" />
  <meta name="keywords" content="web3auth, twitch, twitch authentication, authentication, auth, web3" />
</head>
...
[Web3Auth Core Twitch Login Example](https://github.com/Web3Auth/examples/tree/main/twitch-core-react-example). Check it out and try running it
locally yourself!
