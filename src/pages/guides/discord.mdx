---
title: Using Discord with Web3Auth Core
image: "/docs/contents/guides/banners/discord.svg"
description: Learn how to use Web3Auth Core for Discord Custom Authentication.
type: guide
tags: [ethereum, web3auth, web3auth core, react, discord]
date: 18th July 2022
