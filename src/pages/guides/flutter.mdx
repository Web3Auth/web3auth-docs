...
`account`, fetch `balance`, `sign transaction`, `send transaction`.

Repository: https://github.com/Web3Auth/examples/raw/main/flutter/flutter
...
Checkout the full codes to interact with [ETH Blockchain](/docs/connect-blockchain/ethereum/flutter).
...
[Web3Auth Flutter Example](https://github.com/Web3Auth/examples/tree/main/flutter/flutter). Check it out and try running it locally yourself!

`flutter run`

Also, checkout other examples:

- [Using Google's Custom Authentication](https://github.com/Web3Auth/examples/tree/main/flutter/custom-authentication-example/using-google)
- [Using Custom JWT (via Firebase)](https://github.com/Web3Auth/examples/tree/main/flutter/custom-authentication-example/using-jwt-firebase)
