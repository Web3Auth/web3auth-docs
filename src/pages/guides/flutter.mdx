...
- Add `{YOUR_APP_PACKAGE_NAME}://auth` and `\(bundleId)://auth` in the **Whitelist URL** field of the Web3Auth Dashboard.

### Configure Deep Link

For Android build, Open your app's `AndroidManifest.xml` file and add the following deep link intent filter to your sign-in activity:
