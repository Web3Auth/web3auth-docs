...
flutter run
# We also have demo apps with Auth0 and Firebase(JWT),  try these:
# cd flutter/flutter-auth0-example && flutter run
# or
# cd flutter/flutter-firebase-example && flutter run
```
