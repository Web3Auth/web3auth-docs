...
**Demo APK:** [Download](https://github.com/Web3Auth/examples/raw/main/android/web3auth-android-demo-app.apk)

Repository: https://github.com/Web3Auth/examples/raw/main/android
