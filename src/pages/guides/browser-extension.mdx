...
Install `@web3auth/no-modal`, `@web3auth/openlogin-adapter`, `@web3auth/ethereum-provider` &
`@web3auth/base`
...
Create the Web3Auth instance and configure the Openlogin adapter, in case of no-modal SDK, as per
your requirements.
