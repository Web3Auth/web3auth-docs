...
description: Learn how to use Web3Auth Plug and Play Core SDK in your iOS app
type: guide
...
<SEO
  title="Using Web3Auth's iOS SDK"
  description="Learn how to use Web3Auth Plug and Play Core SDK in your iOS application"
...
All the below code snippets are based on the above initialization.
