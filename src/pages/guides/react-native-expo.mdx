...
image: "contents/guides/banners/expo.png"
...
<SEO
  title="Using Web3Auth React Native SDK in Expo Workflow"
  description="Learn how to use Web3Auth Plug and Play React Native SDK in your Expo app"
  image="https://web3auth.io/docs/contents/guides/banners/expo.png"
...
Repository: https://github.com/Web3Auth/examples/tree/main/react-native/rn-expo-example
...
[Web3Auth React Native Example](https://github.com/Web3Auth/examples/tree/main/react-native/rn-expo-example). Check it out and try running it locally
yourself!
