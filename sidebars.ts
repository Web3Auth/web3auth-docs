    ...
    "sdk/pnp/web/web",
    {
      ...
      items: [
        ...
        "sdk/pnp/web/modal/config",
        {
          ...
          label: "React SDK",
          items: [
            "sdk/pnp/web/modal/react/setup",
            "sdk/pnp/web/modal/react/auth",
            "sdk/pnp/web/modal/react/identity",
            "sdk/pnp/web/modal/react/mfa",
            "sdk/pnp/web/modal/react/wallet-services",
            "sdk/pnp/web/modal/react/blockchain-connection",
          ],
        },
        {
          type: "category",
          ...
          label: "Vue SDK",
          items: [
            "sdk/pnp/web/modal/vue/setup",
            "sdk/pnp/web/modal/vue/auth",
            "sdk/pnp/web/modal/vue/identity",
            "sdk/pnp/web/modal/vue/mfa",
            "sdk/pnp/web/modal/vue/wallet-services",
            "sdk/pnp/web/modal/vue/blockchain-connection",
          ],
        },
        {
          type: "category",
          ...
          items: [
            "sdk/pnp/web/modal/js/setup",
            "sdk/pnp/web/modal/js/auth",
            "sdk/pnp/web/modal/js/identity",
            "sdk/pnp/web/modal/js/mfa",
            "sdk/pnp/web/modal/js/wallet-services",
            "sdk/pnp/web/modal/js/blockchain-connection",
          ],
        },
        {
          type: "category",
          ...
          items: [
            ...
            "sdk/pnp/web/modal/advanced/whitelabel",
            "sdk/pnp/web/modal/advanced/custom-authentication",
            "sdk/pnp/web/modal/advanced/mfa",
          ],
        },
    ...
    },
    {
      ...
      items: [
        ...
        "sdk/pnp/web/no-modal/config",
        {
          ...
          label: "React SDK",
          items: [
            "sdk/pnp/web/no-modal/react/setup",
            "sdk/pnp/web/no-modal/react/auth",
            "sdk/pnp/web/no-modal/react/identity",
            "sdk/pnp/web/no-modal/react/mfa",
            "sdk/pnp/web/no-modal/react/wallet-services",
            "sdk/pnp/web/no-modal/react/blockchain-connection",
          ],
        },
        {
          type: "category",
          ...
          label: "Vue SDK",
          items: [
            "sdk/pnp/web/no-modal/vue/setup",
            "sdk/pnp/web/no-modal/vue/auth",
            "sdk/pnp/web/no-modal/vue/identity",
            "sdk/pnp/web/no-modal/vue/mfa",
            "sdk/pnp/web/no-modal/vue/wallet-services",
            "sdk/pnp/web/no-modal/vue/blockchain-connection",
          ],
        },
        {
          type: "category",
          ...
          label: "JavaScript SDK",
          items: [
            "sdk/pnp/web/no-modal/js/setup",
            "sdk/pnp/web/no-modal/js/auth",
            "sdk/pnp/web/no-modal/js/identity",
            "sdk/pnp/web/no-modal/js/mfa",
            "sdk/pnp/web/no-modal/js/wallet-services",
            "sdk/pnp/web/no-modal/js/blockchain-connection",
          ],
        },
        {
          type: "category",
          ...
          label: "Advanced Settings",
          items: [
            "sdk/pnp/web/no-modal/advanced/account-abstraction",
            "sdk/pnp/web/no-modal/advanced/whitelabel",
            "sdk/pnp/web/no-modal/advanced/custom-authentication",
            "sdk/pnp/web/no-modal/advanced/mfa",
          ],
        },
