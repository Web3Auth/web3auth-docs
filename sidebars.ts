...
<path d="M3.59022 12.2135L10.59 2.21384C10.651 2.12674 10.7382 2.06135 10.8389 2.02718C10.9396 1.99301 11.0486 1.99184 11.15 2.02384L11.1801 2.03333C11.2692 2.06763 11.3468 2.12683 11.4036 2.20416C11.4665 2.28995 11.5005 2.39358 11.5004 2.49999V2.50002V7.50002V8.00002H12.0004H16.0004H16.0007C16.0921 7.99998 16.1818 8.02502 16.2601 8.07243C16.3383 8.11984 16.402 8.18779 16.4443 8.26889C16.4865 8.34999 16.5058 8.44113 16.4998 8.5324C16.4939 8.62367 16.4631 8.71156 16.4107 8.78652L9.41083 18.7863L9.41044 18.7868C9.34953 18.8741 9.26236 18.9397 9.16161 18.974C9.06087 19.0083 8.95181 19.0095 8.85029 18.9776C8.74878 18.9456 8.66011 18.8821 8.59719 18.7963C8.53427 18.7104 8.50038 18.6068 8.50044 18.5003V18.5V13.5V13H8.00044H4.00045H4.00022C3.90876 13.0001 3.81904 12.975 3.74083 12.9276C3.66262 12.8802 3.59891 12.8122 3.55663 12.7311C3.51435 12.65 3.49513 12.5589 3.50105 12.4676C3.50697 12.3764 3.53782 12.2885 3.59022 12.2135Z" fill="currentColor" stroke="currentColor"/>
      ...
      items: [
        ...
        "auth-provider-setup/aggregate-verifier",
        {
          ...
          items: [
            ...
            { type: "autogenerated", dirName: "auth-provider-setup/social-providers" },
          ],
          collapsible: true,
          collapsed: false,
        },
        {
          ...
          items: [
            {
              type: "autogenerated",
              dirName: "auth-provider-setup/authentication-service-providers",
            },
          ],
          collapsible: true,
          collapsed: false,
        },
        {
          ...
          items: [
            ...
            { type: "autogenerated", dirName: "auth-provider-setup/byo-jwt-provider" },
          ],
          collapsible: true,
          collapsed: false,
        },
  ...
  sdk_pnp_web: [
    ...
    "sdk/pnp/web/web",
    {
      ...
      items: [
        ...
        "sdk/pnp/web/modal/config",
        {
          ...
          items: [
            "sdk/pnp/web/modal/react/setup",
            {
              ...
              items: [{ type: "autogenerated", dirName: "sdk/pnp/web/modal/react/hooks" }],
            },
            "sdk/pnp/web/modal/react/ethereum-hooks",
            {
              type: "category",
              collapsible: true,
              collapsed: false,
              label: "Solana Hooks",
              items: [{ type: "autogenerated", dirName: "sdk/pnp/web/modal/react/solana-hooks" }],
            },
          ],
        },
        {
          ...
          items: [
            "sdk/pnp/web/modal/vue/setup",
            {
              ...
              items: [{ type: "autogenerated", dirName: "sdk/pnp/web/modal/vue/composables" }],
            },
            "sdk/pnp/web/modal/vue/ethereum-composables",
            {
              type: "category",
              collapsible: true,
              collapsed: false,
              ...
              items: [
                { type: "autogenerated", dirName: "sdk/pnp/web/modal/vue/solana-composables" },
              ],
            },
          ],
        },
        {
          ...
          items: [{ type: "autogenerated", dirName: "sdk/pnp/web/modal/js" }],
        },
        {
          type: "category",
          collapsible: true,
          ...
          items: [{ type: "autogenerated", dirName: "sdk/pnp/web/modal/advanced" }],
        },
    ...
    //       collapsed: false,
    //       label: "React SDK",
    //       items: [{ type: "autogenerated", dirName: "sdk/pnp/web/no-modal/react" }],
    //     },
    //     {
    //       type: "category",
    //       collapsible: true,
    //       collapsed: false,
    //       label: "Vue SDK",
    //       items: [{ type: "autogenerated", dirName: "sdk/pnp/web/no-modal/vue" }],
    //     },
    //     {
    //       type: "category",
    //       collapsible: true,
    //       collapsed: false,
    //       label: "JavaScript SDK",
    //       items: [{ type: "autogenerated", dirName: "sdk/pnp/web/no-modal/js" }],
    //     },
    //     {
    //       type: "category",
    //       collapsible: true,
    //       collapsed: false,
    //       label: "Advanced Settings",
    //       items: [{ type: "autogenerated", dirName: "sdk/pnp/web/no-modal/advanced" }],
    //     },
