...
[The wallet generated for each user is specific to a verifier.](/docs/troubleshooting/different-private-key#verifier)**
...
- It is advisable to create an `Aggregate Multiple Providers` verifier even if you're using just one login method for now. This will help you in the
  future if you want to add more login methods to use the [**Aggregate Verifier**](/docs/auth-provider-setup/aggregate-verifier) feature of Web3Auth
  in your application.
