...
Web3Auth employs an internal blockchain based on Polkadot to store and manage verifier information
securely. This blockchain approach ensures that verifier data is accessible to Auth Network nodes in
a decentralized and tamper-proof manner, facilitating reliable authentication across the Web3Auth
ecosystem.
