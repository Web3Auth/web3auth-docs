...
- It is advisable to create a `Aggregate Multiple Providers` verifier even if you're using just one login method for now. This will help you in the
  future if you want to add more login methods to use [**Aggregate Verifier**](/docs/auth-provider-setup/aggregate-verifier) feature of Web3Auth in
  your application.
