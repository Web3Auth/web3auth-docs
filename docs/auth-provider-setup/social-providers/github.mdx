...
3. Enter the `Auth0 Client ID` and `Auth0 Domain` from your Auth0 application. See how to create a new Auth0 application
   ...
   ![Github - Domain and Client ID from Auth0 Dashboard](/content-hub/guides/auth0/auth0-guide-clientid.png)
   ![Github - Auth0 Client ID and Auth0 Domain on Web3Auth Dashboard](/dashboard/verifiers/auth0-verifier.png)
