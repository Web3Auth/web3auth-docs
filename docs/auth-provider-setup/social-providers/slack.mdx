...
Slack login can be performed in various ways, depending on the use case. We have demonstrated this with Auth0, but this can be done with any other
Federated/JWT providers.

:::

## Set up [Slack](https://marketplace.auth0.com/integrations/sign-in-with-slack) via Auth0
...
4. Add the [Slack Social Connection](https://marketplace.auth0.com/integrations/sign-in-with-slack) to your Auth0 application.
