...
Microsoft login can be performed in various ways, depending on the use case. We have demonstrated this with Auth0, but this can be done with any other
...
4. Add the [Microsoft Social Connection](https://marketplace.auth0.com/integrations/microsoft-account-social-connection) to your Auth0 application.
