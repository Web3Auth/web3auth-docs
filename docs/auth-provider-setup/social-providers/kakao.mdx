...
modal. ![KaKao - Login Providers list on Web3Auth
Dashboard](/images/dashboard/create-verifier-auth0.png) 2. Select the `KaKao` as the
**Authentication Type** based on the dropdown. ![KaKao - Auth0 Authentication Type list on Web3Auth
