...
- Critical \($10,000\) - Bugs that allow theft of user keys under normal
  operating conditions
  - Eg. Ability to access private key from the dapp JS context
- High \($5000\) - Bugs that restrict user access to keys, cause loss of funds,
...
- Medium \($800\) - Bugs that affect user access, cause service downtime, or
