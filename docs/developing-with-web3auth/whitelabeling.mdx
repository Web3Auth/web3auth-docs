...
You can do whitelabelling across `Web3Auth`, `Openlogin Adapter`, and `Torus Wallet Adapter` instances.
...
<div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
  ...
  <div style={{ flexBasis: "30%", flexGrow: "1", alignItems: "center" }}>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-modal-openlogin.png" />
  </div>
</div>
...
<div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
  <div style={{ flexBasis: "30%", flexGrow: "1", alignItems: "center" }}>
    ...
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-openlogin-light.png" />
  </div>
  <div style={{ flexBasis: "30%", flexGrow: "1", alignItems: "center" }}>
    <h4>
      Dark <code>true</code>
    </h4>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-openlogin-dark.png" />
  </div>
</div>
<br />
...
<div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
  <div style={{ flexBasis: "30%", flexGrow: "1", alignItems: "center" }}>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-openlogin-theme1.png" />
  </div>
  <div style={{ flexBasis: "30%", flexGrow: "1", alignItems: "center" }}>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-openlogin-theme2.png" />
  </div>
</div>
<br />

<div style={{ flexBasis: "300px", flexGrow: "1", textAlign: "center" }}>
  <img src="" style={{ alignSelf: "center", maxWidth: "90%" }} />
</div>
...
<div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
  <div style={{ flexBasis: "10%", flexGrow: "10" }}>
    <ul>
      <li>
  ...
  <div style={{ flexBasis: "50%", flexGrow: "10", alignItems: "center" }}>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-openlogin-language.png" />
  </div>
</div>
<br />
...
<div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
  <div style={{ flexBasis: "30%", flexGrow: "1", alignItems: "center" }}>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-wallet-popup1.png" />
  </div>
  <div style={{ flexBasis: "15%", flexGrow: "1", alignItems: "center" }}>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-wallet-popup2.png" />
  </div>
</div>
...
<div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
  <div style={{ flexBasis: "30%", flexGrow: "1", alignItems: "center" }}>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-wallet-widget1.png" />
  </div>
  <div style={{ flexBasis: "30%", flexGrow: "1", alignItems: "center" }}>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-wallet-widget2.png" />
  </div>
</div>
...
<div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
  <div style={{ flexBasis: "50%", flexGrow: "1", alignItems: "center" }}>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-wallet-wallet1.png" />
  </div>
  <div style={{ flexBasis: "50%", flexGrow: "1", alignItems: "center" }}>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-wallet-wallet2.png" />
  </div>
</div>
...
<div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
  <div style={{ flexBasis: "15%", flexGrow: "1", alignItems: "center" }}>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-wallet-modal1.png" />
  </div>
  <div style={{ flexBasis: "30%", flexGrow: "1", alignItems: "center" }}>
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src="/contents/whitelabel-web3auth-wallet-modal2.png" />
  </div>
</div>
