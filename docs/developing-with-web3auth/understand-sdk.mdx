...
### OpenLogin React Native Expo SDK

### [`openlogin-expo-sdk`](https://github.com/torusresearch/openlogin-expo-sdk)

While we migrate our React Native Expo SDK to Web3Auth, you can use our OpenLogin SDK for React Native Expo, which essentially helps you use a
...
OpenLogin Expo SDK essentially is the same as Web3Auth React Native SDK, but compatible with the Expo project setup, where you don't need to add
custom setup for Android and iOS platforms.
