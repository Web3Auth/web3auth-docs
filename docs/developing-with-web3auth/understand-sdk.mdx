...
Head on to the [Custom Login UI API Reference](./customui) to get started.
...
## Android (Kotlin) [`web3auth-android-sdk`](https://github.com/Web3Auth/web3auth-android-sdk)
...
Since the Android SDK doesn't have adapter and provider packages, it exposes the private key to the client side application of Android, using which
you can easily invoke RPC calls on wallet and on connected blockchain.

:::

---

## iOS (Swift) [`web3auth-swift-sdk`](https://github.com/Web3Auth/web3auth-swift-sdk)
...
Since the iOS SDK doesn't have adapter and provider packages, it exposes the private key to the client side application of iOS, using which you can
easily invoke RPC calls on wallet and on connected blockchain.
...
### OpenLogin React Native SDK [`openlogin-react-native-sdk`](https://github.com/torusresearch/openlogin-react-native-sdk)

While we migrate our React Native SDK to Web3Auth, you can use our OpenLogin SDK for React Native, which essentially helps you use a
[Plug and Play Project](/get-started/using-dashboard#plug-and-play) from the Web3Auth Dashboard and helps your sign in natively using your Android or
iOS device.

### OpenLogin RN Expo SDK [`openlogin-expo-sdk`](https://github.com/torusresearch/openlogin-expo-sdk)

OpenLogin Expo SDK essentially is the same as React Native SDK, but compatible with the expo project setup, where you don't need to add custom setup
for Android and iOS platforms.

### CustomAuth React Native SDK [`customauth-react-native-sdk`](https://github.com/torusresearch/customauth-react-native-sdk)

CustomAuth React Native SDK helps you to add your own custom authentication verifiers to integrate with your existing authentication within your react
native application.

:::note

Since the React Native SDKs don't have adapter and provider packages, they expose the private key to the client side application of iOS and Android
respectively, using which you can easily invoke RPC calls on wallet and on connected blockchain.
...
### OpenLogin Flutter SDK [`openlogin-flutter-sdk`](https://github.com/torusresearch/openlogin-flutter-sdk)

While we migrate our Flutter SDK to Web3Auth, you can use our OpenLogin SDK for React Native, which essentially helps you use a
[Plug and Play Project](/get-started/using-dashboard#plug-and-play) from the Web3Auth Dashboard and helps your sign in natively using your Android or
iOS device.

### CustomAuth Flutter SDK [`customauth-flutter-sdk`](https://github.com/torusresearch/customauth-flutter-sdk)

CustomAuth Flutter SDK helps you to add your own custom authentication verifiers to integrate with your existing authentication within your flutter
application.

:::note

Since the Flutter SDKs don't have adapter and provider packages, they expose the private key to the client side application of iOS and Android
respectively, using which you can easily invoke RPC calls on wallet and on connected blockchain.
