...
[Avalanche](https://www.avalabs.org) blockchain calls like getting user's `account`, fetch `balance`, `sign transaction`, `send transaction`, `read`
...
Mainnet Block Explorer URL: https://subnets.avax.network/c-chain
...
Testnet Block Explorer URL: https://subnets-test.avax.network/c-chain
