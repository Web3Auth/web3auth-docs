...
image: "guides/banners/algorand.png"
...
This reference is for the `Web`, however, you can use Algorand on other Mobile and Gaming Platforms as well. Please follow our reference for
[EVM Blockchains](/connect-blockchain/evm/), and similarly use Algorand libraries that support the platforms to use the private key and make
