...
sidebar_label: Tezos
image: "guides/banners/tezos.png"
...
This reference is for the `Web`, however, you can use Tezos on other Mobile and Gaming Platforms as well. Please follow our reference for
[EVM Blockchains](/connect-blockchain/evm/), and similarly use Tezos libraries that support the platforms to use the private key and make blockchain
calls accordingly.
