...
image: "guides/banners/bitcoin.png"
displayed_sidebar: resources
keywords: [bitcoin, taproot, web3auth, authentication, blockchain]
...
`Note: This documentation is for the Bitcoin Taproot integration.`
