...
- [Ripple Providers](/sdk/helper-sdks/providers/ripple)
- [Other Providers](/sdk/helper-sdks/providers/other)
...
You can read more about this in our [**Provider SDK Reference**](/sdk/pnp/web/providers)
