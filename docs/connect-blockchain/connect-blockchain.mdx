...
authentication. This provider can be use to interact with wallet or connected chain using RPC calls. Currently, Web3Auth supports providers for both
...
can follow our API Reference to know more about how to use these providers with thier compatible adapters:
