---
title: Connect to any Blockchain
...
Web3Auth is the frontend authentication system for your dApp. Once the user is authenticated, the Web3Auth SDK returns a provider. Using this returned
provider we can sign transactions and **make RPC calls to any blockchain**.
