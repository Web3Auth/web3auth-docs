...
To interact with the Ethereum blockchain in React Native, you can use any EIP1193 compatible package like
...
const web3auth = new Web3Auth(WebBrowser, {
  clientId,
  network: OPENLOGIN_NETWORK.TESTNET, // MAINNET or CYAN
});
