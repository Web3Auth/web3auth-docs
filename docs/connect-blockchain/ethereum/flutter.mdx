...
Via Web3Auth Flutter SDK, you can interact with [Ethereum](https://ethereum.org/) to get access to user's `account`, fetch `balance`,
`sign transaction`, `send transaction`, and even `read` from and `write` to the smart contract.

## Installation

---

To interact with the Ethereum blockchain in Flutter, you can use [web3dart](https://pub.dev/packages/web3dart) package with Web3Auth.

```dart
flutter pub add web3dart shared_preferences
```

> Note: We are also using `shared_preferences` package to share `privateKey` at various places in codes below.
...
```dart
// Use codes from Initialization here, and replace the `Widget build` from the below code:
            ...
            Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  debugPrint("UserInfo, ${response.toString()}");
                },
