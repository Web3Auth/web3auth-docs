...
To interact with the Ethereum blockchain in Flutter, you can use any EIP1193 compatible package. Here, we're using
[web3dart](https://pub.dev/packages/web3dart) to demonstrate how to make blockchain calls using it with Web3Auth.
