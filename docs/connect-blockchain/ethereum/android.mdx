...
While using the Web3Auth Android SDK, you get the private key within the user scope. This private key can interact with
...
To interact with the Ethereum blockchain in Android, you can use any EIP1193 compatible package available for Android. Here we're using
[web3j](https://github.com/web3j/web3j) to demonstrate how to make blockchain calls using it with Web3Auth.
