...
[Moonriver's](https://moonbeam.network/networks/moonriver/) blockchain calls like getting the user's `account`, fetching `balance`,
...
This reference is for the `Web`, however, you can use Moonriver on `Android`, `iOS`, `React Native`, `Flutter`, & `Unity` as well. Please follow our
reference for [Ethereum](/connect-blockchain/ethereum/), and change the RPC Provider URL & configurations corresponding to Moonriver.
