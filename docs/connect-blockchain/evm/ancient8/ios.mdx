...
description:
  "Integrate Web3Auth with the Ancient8 Blockchain in iOS/Swift Applications | Documentation -
  Web3Auth"
---
...
<SEO
  ...
  slug="/connect-blockchain/evm/ancient8/ios"
/>

While using the Web3Auth iOS SDK, you get the private key within the user scope. This private key
can interact with [Ancient8 Blockchain](https://ancient8.gg) to make any blockchain calls, like
