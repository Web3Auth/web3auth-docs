...
description:
  "Integrate Web3Auth with the Cronos Blockchain in iOS/Swift Applications | Documentation -
  Web3Auth"
---
...
can interact with [Cronos](https://cronos.org/) to make any blockchain calls, like getting the
