...
sidebar_label: iOS
image: "/docs/content-hub/guides/banners/cronos.png"
...
<SEO
  ...
  slug="/connect-blockchain/evm/cronos/ios"
/>

While using the Web3Auth iOS SDK, you get the private key within the user scope. This private key can interact with [Cronos](https://cronos.org/) to
...
- Chain ID: 0x19
- Public RPC URL: https://rpc.cronos.org (Avoid using public rpcTarget in production, use services like Infura, Quicknode etc)
...
- Chain ID: 0x152
- Public RPC URL: https://rpc-t3.cronos.org (Avoid using public rpcTarget in production, use services like Infura, Quicknode etc)
