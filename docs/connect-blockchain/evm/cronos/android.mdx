...
<SEO
  ...
  slug="/connect-blockchain/evm/cronos/android"
/>
...
[Cronos](https://cronos.org/) to make any blockchain calls, like getting the user's `account`, fetching `balance`, `sign transaction`,
