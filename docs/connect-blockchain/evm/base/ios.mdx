...
description:
  "Integrate Web3Auth with the Base Chain (Coinbase) Blockchain in iOS/Swift Applications |
...
can interact with [Base Chain (Coinbase)](https://base.org/) to make any blockchain calls, like
