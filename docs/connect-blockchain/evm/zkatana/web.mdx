---
title: Integrate Web3Auth with the zKatana Blockchain in JavaScript
sidebar_label: Web
image: "content-hub/guides/banners/zkatana.png"
displayed_sidebar: docs
keywords: [zkatana, web3auth, authentication, blockchain]
description: "Integrate Web3Auth with the zKatana Blockchain in JavaScript | Documentation - Web3Auth"
---
...
<SEO
  ...
  slug="/connect-blockchain/evm/zkatana/web"
/>
...
To interact with the zKatana blockchain, you can use either library with Web3Auth.
