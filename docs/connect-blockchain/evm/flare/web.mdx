---
title: Integrate Web3Auth with the Flare Blockchain in JavaScript
sidebar_label: Web
...
<SEO
  ...
  slug="/connect-blockchain/evm/flare/web"
/>
...
[Flare](https://www.flare.network) blockchain calls like getting the user's `account`, fetching `balance`, `sign transaction`, `send transaction`,
