...
sidebar_label: iOS
image: "/docs/content-hub/guides/banners/flare.png"
...
While using the Web3Auth iOS SDK, you get the private key within the user scope. This private key can interact with [Flare](https://www.flare.network)
