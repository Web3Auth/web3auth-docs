...
description:
  "Integrate Web3Auth with the XPLA Blockchain in React Native | Documentation - Web3Auth"
---
...
<SEO
  ...
  slug="/connect-blockchain/evm/xpla/react-native"
/>
...
[`ethers.js`](https://docs.ethers.io/v5/getting-started/) etc. to make [XPLA](https://xpla.io/)
