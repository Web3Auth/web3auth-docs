...
<SEO
  ...
  slug="/connect-blockchain/evm/xpla"
/>

Integrate Web3Auth seamlessly with EVM-based XPLA blockchain. For Web SDKs, Web3Auth returns a
    ...
    tiles: [
      {
        ...
        title: "Web",
        icon: "logo-js.png",
        path: "/connect-blockchain/evm/xpla/web",
      },
      {
        key: "android",
        title: "Android (Kotlin)",
        icon: "logo-android.png",
        path: "/connect-blockchain/evm/xpla/android",
      },
      {
        key: "apple",
        title: "iOS (Swift)",
        icon: "logo-apple.png",
        path: "/connect-blockchain/evm/xpla/ios",
      },
      {
        key: "flutter",
        title: "Flutter",
        icon: "logo-flutter.png",
        path: "/connect-blockchain/evm/xpla/flutter",
      },
      {
        key: "react-native",
        title: "React Native",
        icon: "logo-react.png",
        path: "/connect-blockchain/evm/xpla/react-native",
      },
      {
        key: "unity",
        title: "Unity",
        icon: "logo-unity.png",
        path: "/connect-blockchain/evm/xpla/unity",
      },
    ],
  },
];
