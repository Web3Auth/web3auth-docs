...
description:
  "Integrate Web3Auth with the Polygon Blockchain in iOS/Swift Applications | Documentation -
  Web3Auth"
---
...
- Chain ID: 0x13882
- Public RPC URL: hhttps://rpc-amoy.polygon.technology/ (Avoid using public rpcTarget in production,
  use services like Infura, Quicknode etc)
- Display Name: Polygon Amoy Testnet
- Block Explorer Link: https://www.oklink.com/amoy
- Ticker: MATIC
- Ticker Name: MATIC
