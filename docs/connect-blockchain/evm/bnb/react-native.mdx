...
keywords: [react-native, binance, bnb, bsc, binanace smart chain, web3auth, authentication, blockchain]
...
[BNB (Binance) Chain](https://www.bnbchain.org/) blockchain calls like getting the user's `account`, fetching `balance`, `sign transaction`,
