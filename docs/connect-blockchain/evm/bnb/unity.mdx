...
description:
  "Integrate Web3Auth with the BNB (Binance) Blockchain in Unity | Documentation - Web3Auth"
---
...
can interact with the [BNB (Binance) Chain](https://www.bnbchain.org/) to make EVM-based blockchain
