...
<SEO
  ...
  slug="/connect-blockchain/evm/bnb/unity"
/>

While using the Web3Auth Unity SDK, you get the private key within the user scope. This private key can interact with the
[BNB (Binance) Chain](https://www.bnbchain.org/) to make EVM-based blockchain calls, like getting the user's `account`, fetch `balance`,
