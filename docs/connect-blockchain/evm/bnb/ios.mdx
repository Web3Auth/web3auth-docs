...
description:
  "Integrate Web3Auth with the BNB (Binance) Blockchain in iOS/Swift Applications | Documentation -
  Web3Auth"
---
...
can interact with [BNB (Binance) Chain](https://www.bnbchain.org/) to make any blockchain calls,
...
- Chain ID: 0x38
- Public RPC URL: https://bsc-dataseed.bnbchain.org (Avoid using public rpcTarget in production, use
...
- Chain ID: 0x61
- Public RPC URL: https://bsc-testnet.bnbchain.org (Avoid using public rpcTarget in production, use
  services like Infura)
