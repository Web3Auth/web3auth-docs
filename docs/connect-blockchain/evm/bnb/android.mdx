...
<SEO
  ...
  slug="/connect-blockchain/evm/bnb/android"
/>
...
[BNB (Binance) Chain](https://www.bnbchain.org/) to make any blockchain calls, like getting the user's `account`, fetch `balance`, `sign transaction`,
