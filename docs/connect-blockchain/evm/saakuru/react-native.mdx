---
title: Integrate Web3Auth with the Saakuru Mainnet in React Native
sidebar_label: React Native
image: "guides/banners/saakuru.png"

keywords: [react-native, saakuru, web3auth, authentication, blockchain]
description:
  "Integrate Web3Auth with the Saakuru Mainnet in React Native | Documentation - Web3Auth"
---
...
<SEO
  title="Integrate Web3Auth with the Saakuru Mainnet in React Native"
  description="Integrate Web3Auth with the Saakuru Mainnet in React Native | Documentation - Web3Auth"
  image="https://web3auth.io/docs/guides/banners/saakuru.png"
  slug="/connect-blockchain/evm/saakuru/react-native"
/>
