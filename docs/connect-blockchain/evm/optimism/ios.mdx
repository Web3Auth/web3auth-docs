...
sidebar_label: iOS
image: "/docs/content-hub/guides/banners/optimism.png"
...
<SEO
  ...
  slug="/connect-blockchain/evm/optimism/ios"
/>

While using the Web3Auth iOS SDK, you get the private key within the user scope. This private key can interact with [Optimism](https://optimism.io/)
...
- Chain ID: 0xA
- Public RPC URL: https://rpc.ankr.com/optimism (Avoid using public rpcTarget in production, use services like Infura, Quicknode etc)
...
- Chain ID: 0x45
- Public RPC URL: https://rpc.ankr.com/optimism_testnet (Avoid using public rpcTarget in production, use services like Infura, Quicknode etc)
