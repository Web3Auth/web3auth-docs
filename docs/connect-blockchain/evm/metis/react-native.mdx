...
description:
  "Integrate Web3Auth with the Metis Blockchain in React Native | Documentation - Web3Auth"
---
...
<SEO
  ...
  slug="/connect-blockchain/evm/metis/react-native"
/>
...
[Metis Blockchain](https://metis.io) blockchain calls like getting the user's `account`, fetching
