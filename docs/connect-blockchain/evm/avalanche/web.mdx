---
title: Integrate Web3Auth with the Avalanche Blockchain in JavaScript
sidebar_label: Web
image: "banners/avalanche.png"
keywords: [avalanche, web3auth, authentication, blockchain]
description:
  "Integrate Web3Auth with the Avalanche Blockchain in JavaScript | Documentation - Web3Auth"
---
...
<SEO
  title="Integrate Web3Auth with the Avalanche Blockchain in JavaScript"
  description="Integrate Web3Auth with the Avalanche Blockchain in JavaScript | Documentation - Web3Auth"
  image="https://web3auth.io/docs/banners/avalanche.png"
  slug="/connect-blockchain/evm/avalanche/web"
/>
...
[Avalanche](https://www.avax.network/) blockchain calls like getting the user's `account`, fetching
...
To interact with the Avalanche blockchain, you can use either library with Web3Auth.
