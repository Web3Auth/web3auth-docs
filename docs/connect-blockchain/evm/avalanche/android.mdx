...
<SEO
  ...
  slug="/connect-blockchain/evm/avalanche/android"
/>
...
[Avalanche (C-Chain)](https://www.avax.network/) to make any blockchain calls, like getting the user's `account`, fetch `balance`, `sign transaction`,
