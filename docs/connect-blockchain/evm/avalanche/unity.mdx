...
description: "Integrate Web3Auth with the Avalanche (C-Chain) Blockchain in Unity | Documentation - Web3Auth"
---
...
[Avalanche (C-Chain)](https://www.avax.network/) to make EVM-based blockchain calls, like getting the user's `account`, fetch `balance`,
