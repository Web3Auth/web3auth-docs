...
description:
  "Integrate Web3Auth with the Avalanche (C-Chain) Blockchain in iOS/Swift Applications |
...
can interact with [Avalanche (C-Chain)](https://www.avax.network/) to make any blockchain calls,
