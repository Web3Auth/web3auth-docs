...
description:
  "Integrate Web3Auth with the Manta Blockchain in React Native | Documentation - Web3Auth"
---
...
<SEO
  ...
  slug="/connect-blockchain/evm/manta/react-native"
/>
...
[Manta Blockchain](https://manta.network/) blockchain calls like getting the user's `account`,
