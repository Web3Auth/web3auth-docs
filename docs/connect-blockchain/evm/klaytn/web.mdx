...
<SEO
  ...
  slug="/connect-blockchain/evm/klaytn/web"
/>
...
[Klaytn](https://klaytn.foundation) blockchain calls like getting the user's `account`, fetching `balance`, `sign transaction`, `send transaction`,
