---
title: Integrate Web3Auth with the Klatyn Blockchain in Flutter
sidebar_label: Flutter
image: "content-hub/guides/banners/klatyn.png"
displayed_sidebar: docs
keywords: [flutter, klatyn, web3auth, authentication, blockchain]
description: "Integrate Web3Auth with the Klatyn Blockchain in Flutter | Documentation - Web3Auth"
---
...
<SEO
  ...
  slug="/connect-blockchain/evm/klatyn/flutter"
/>

While using the Web3Auth Flutter SDK, you get the private key within the user scope. This private key can interact with
[Klatyn](https://klaytn.foundation) to make any blockchain calls, like getting the user's `account`, fetch `balance`, `sign transaction`,
