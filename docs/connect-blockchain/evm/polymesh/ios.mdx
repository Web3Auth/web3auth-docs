---
title: Integrate Web3Auth with the Polymesh Blockchain in iOS/Swift Applications
sidebar_label: iOS
image: "/docs/content-hub/guides/banners/polymesh.png"
displayed_sidebar: docs
keywords: [ios, swift, polymesh, web3auth, authentication, blockchain]
description: "Integrate Web3Auth with the Polymesh Blockchain in iOS/Swift Applications | Documentation - Web3Auth"
---
...
<SEO
  ...
  slug="/connect-blockchain/evm/polymesh/ios"
/>

While using the Web3Auth iOS SDK, you get the private key within the user scope. This private key can interact with
[Polymesh](https://polymesh.network/) to make any blockchain calls, like getting the user's `account`, fetching `balance`, `sign transaction`,
...
- Chain ID: 0x1
- Public RPC URL: `https://mainnet-rpc.polymesh.network` (Avoid using public rpcTarget in production, use services like Infura, Quicknode etc)
...
- Chain ID: 0x5
- Public RPC URL: `https://testnet-rpc.polymesh.live` (Avoid using public rpcTarget in production, use services like Infura, Quicknode etc)
