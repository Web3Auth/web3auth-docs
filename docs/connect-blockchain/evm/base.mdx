---
title: Integrate Web3Auth with the Base Chain (Coinbase)
sidebar_label: Base Chain (Coinbase)
image: "content-hub/guides/banners/base.png"
displayed_sidebar: docs
keywords: [coinbase, base, web3auth, authentication, blockchain]
description: "Integrate Web3Auth with the Base Chain (Coinbase) | Documentation - Web3Auth"
---
...
[Base Chain (Coinbase)](https://base.org/) blockchain calls like getting the user's `account`, fetch `balance`, `sign transaction`,
...
This reference is for the `Web`, however, you can use Base Chain on `Android`, `iOS`, `React Native`, `Flutter`, & `Unity` as well. Please follow our
reference for [Ethereum](/connect-blockchain/ethereum/), and change the RPC Provider URL & configurations corresponding to Base Chain.

:::

## Installation

To interact with the Base Chain, you can use either [web3.js](https://web3js.readthedocs.io/en/v1.2.8/getting-started.html) or
[ethers.js](https://docs.ethers.io/v5/getting-started/) libraries with Web3Auth.

<InstallationSnippet />

## Initializing Provider (Base Chain)
