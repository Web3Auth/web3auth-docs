...
const chainConfig = getEvmChainConfig(42161, "your_web3auth_client_id"); // For mainnet
```
...
```typescript
const chainConfig = getEvmChainConfig(421613, "your_web3auth_client_id"); // For testnet
```
