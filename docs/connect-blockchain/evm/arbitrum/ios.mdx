...
description:
  "Integrate Web3Auth with the Arbitrum Blockchain in iOS/Swift Applications | Documentation -
  Web3Auth"
---
...
can interact with [Arbitrum](https://arbitrum.io/) to make any blockchain calls, like getting the
