...
description:
  "Integrate Web3Auth with the Astar zkEVM Blockchain in iOS/Swift Applications | Documentation -
  Web3Auth"
---
...
can interact with [Astar zkEVM](https://docs.astar.network/docs/build/zkEVM/) to make any blockchain
