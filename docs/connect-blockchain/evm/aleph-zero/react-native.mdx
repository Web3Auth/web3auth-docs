...
description:
  "Integrate Web3Auth with the Aleph Zero Blockchain in React Native | Documentation - Web3Auth"
---
...
<SEO
  ...
  slug="/connect-blockchain/evm/aleph-zero/react-native"
/>
...
[Aleph Zero Blockchain](https://alephzero.org) blockchain calls like getting the user's `account`,
