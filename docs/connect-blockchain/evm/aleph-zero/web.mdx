...
[Aleph Zero](https://alephzero.org/) blockchain calls like getting the user's `account`, fetching
...
To interact with the Aleph Zero blockchain, you can use either library with Web3Auth.
