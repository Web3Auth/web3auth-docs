...
<SEO
  title="Integrate Web3Auth with the Tron Blockchain"
  description="Integrate Web3Auth with the Tron Blockchain | Documentation - Web3Auth"
  image="https://web3auth.io/docs/guides/banners/tron.png"
...
export const Tron = [
  {
    ...
    tiles: [
      ...
      },
      {
        ...
        path: "/connect-blockchain/evm/tron/android",
      },
      {
        key: "apple",
        title: "iOS (Swift)",
        icon: "logo-apple.png",
        path: "/connect-blockchain/evm/tron/ios",
      },
      {
        key: "flutter",
        title: "Flutter",
        icon: "logo-flutter.png",
        path: "/connect-blockchain/evm/tron/flutter",
      },
      {
        key: "react-native",
        title: "React Native",
        icon: "logo-react.png",
        path: "/connect-blockchain/evm/tron/react-native",
      },
      {
        key: "unity",
        title: "Unity",
        icon: "logo-unity.png",
        path: "/connect-blockchain/evm/tron/unity",
      },
    ],
  },
];
