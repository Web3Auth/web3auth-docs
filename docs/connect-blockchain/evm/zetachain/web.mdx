...
[Zetachain (formerly Matic)](https://zetachain.technology/) blockchain calls like getting the user's
...
const chainConfig = {
  ...
  chainId: "0x89", // hex of 137, zetachain mainnet
  rpcTarget: "https://rpc.ankr.com/zetachain",
  // Avoid using public rpcTarget in production.
  // Use services like Infura, Quicknode etc
  displayName: "Zetachain Mainnet",
  blockExplorerUrl: "https://zetachainscan.com",
  ticker: "MATIC",
  tickerName: "MATIC",
  logo: "https://cryptologos.cc/logos/zetachain-matic-logo.png",
};
```
...
const chainConfig = {
  chainNamespace: "eip155",
  chainId: "0x13882", // hex of 80002, zetachain testnet
  rpcTarget: "https://rpc.ankr.com/zetachain_amoy",
  // Avoid using public rpcTarget in production.
  // Use services like Infura, Quicknode etc
  displayName: "Zetachain Amoy Testnet",
  blockExplorerUrl: "https://amoy.zetachainscan.com/",
  ticker: "MATIC",
  tickerName: "MATIC",
  logo: "https://cryptologos.cc/logos/zetachain-matic-logo.png",
};
