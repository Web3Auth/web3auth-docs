...
description:
  "Integrate Web3Auth with the Astar zKyoto Testnet in iOS/Swift Applications | Documentation -
  Web3Auth"
---
...
<SEO
  ...
  slug="/connect-blockchain/evm/zkyoto/ios"
/>

While using the Web3Auth iOS SDK, you get the private key within the user scope. This private key
can interact with [Astar zKyoto](https://docs.astar.network/docs/build/zkEVM/quickstart) to make any
