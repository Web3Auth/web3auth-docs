...
sidebar_label: Web
image: "content-hub/guides/banners/opbnb.png"
...
[opBNB](https://astar.network/) blockchain calls like getting the user's `account`, fetching `balance`, `sign transaction`, `send transaction`, `read`
