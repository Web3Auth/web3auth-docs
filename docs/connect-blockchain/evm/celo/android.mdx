...
<SEO
  ...
  slug="/connect-blockchain/evm/celo/android"
/>
...
[Celo](https://celo.org/) to make any blockchain calls, like getting the user's `account`, fetch `balance`, `sign transaction`, `send transaction`,
