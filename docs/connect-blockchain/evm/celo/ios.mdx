...
description:
  "Integrate Web3Auth with the Celo Blockchain in iOS/Swift Applications | Documentation - Web3Auth"
---
...
can interact with [Celo](https://celo.org/) to make any blockchain calls, like getting the user's
