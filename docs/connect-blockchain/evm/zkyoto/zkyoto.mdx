...
<SEO
  ...
  slug="/connect-blockchain/evm/zkyoto"
/>

Integrate Web3Auth seamlessly with EVM-based Astar zKyoto Testnet. For Web SDKs, Web3Auth returns a
    ...
    tiles: [
      {
        ...
        title: "Web",
        icon: "logo-js.png",
        path: "/connect-blockchain/evm/zkyoto/web",
      },
      {
        key: "android",
        title: "Android (Kotlin)",
        icon: "logo-android.png",
        path: "/connect-blockchain/evm/zkyoto/android",
      },
      {
        key: "apple",
        title: "iOS (Swift)",
        icon: "logo-apple.png",
        path: "/connect-blockchain/evm/zkyoto/ios",
      },
      {
        key: "flutter",
        title: "Flutter",
        icon: "logo-flutter.png",
        path: "/connect-blockchain/evm/zkyoto/flutter",
      },
      {
        key: "react-native",
        title: "React Native",
        icon: "logo-react.png",
        path: "/connect-blockchain/evm/zkyoto/react-native",
      },
      {
        key: "unity",
        title: "Unity",
        icon: "logo-unity.png",
        path: "/connect-blockchain/evm/zkyoto/unity",
      },
    ],
  },
];
