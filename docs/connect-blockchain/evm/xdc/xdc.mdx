...
<SEO
  ...
  slug="/connect-blockchain/evm/xdc"
/>

Integrate Web3Auth seamlessly with EVM-based XDC Network. For Web SDKs, Web3Auth returns a provider
that can be directly used to initialize the libraries like ethers.js, web3.js etc. and make
