...
const chainConfig = {
  ...
  blockExplorerUrl: "https://staging-legal-crazy-castor.explorer.staging-v3.skalenodes.com/",
  ticker: "sFUEL",
  tickerName: "sFUEL",
};
```
...
const chainConfig = {
  ...
  blockExplorerUrl: "https://staging-utter-unripe-menkar.explorer.staging-v3.skalenodes.com/ ",
  ticker: "sFUEL",
  tickerName: "sFUEL",
};
```
...
const chainConfig = {
  ...
  blockExplorerUrl: "https://staging-faint-slimy-achird.explorer.staging-v3.skalenodes.com/",
  ticker: "sFUEL",
  tickerName: "sFUEL",
};
```
...
const chainConfig = {
  ...
  blockExplorerUrl: "https://staging-aware-chief-gianfar.explorer.staging-v3.skalenodes.com/",
  ticker: "sFUEL",
  tickerName: "sFUEL",
};
```
