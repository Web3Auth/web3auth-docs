...
<SEO
  ...
  slug="/connect-blockchain/evm/zkevm/web"
/>
...
[Astar zkEVM](https://docs.astar.network/docs/build/zkEVM/) blockchain calls like getting the user's `account`, fetching `balance`,
