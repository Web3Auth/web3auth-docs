...
description:
  "Integrate Web3Auth with the Zilliqa Blockchain in React Native | Documentation - Web3Auth"
---
...
<SEO
  ...
  slug="/connect-blockchain/evm/zilliqa/react-native"
/>
...
[Zilliqa Blockchain](https://www.zilliqa.com/) blockchain calls like getting the user's `account`,
