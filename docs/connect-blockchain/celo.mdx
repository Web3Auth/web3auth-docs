...
Via Web3Auth SDK, you can interact with [Celo](https://celo.org/) blockchain to get access to your `account`, fetch `balance`, `sign message`,
...
```js
/*
Simply change the chainId feild of `chainConfig` to `0xaef3` (testnet)
*/
...
const web3auth = new Web3Auth({
  ...
  chainConfig: {
    chainNamespace: "eip155",
    chainId: "0xaef3", // hex of 44787, polygon testnet
  },
});
```
