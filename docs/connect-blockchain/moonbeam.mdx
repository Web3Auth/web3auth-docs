---
title: Integrate Web3Auth with the Moonbeam / Moonriver Blockchain
sidebar_label: Moonbeam / Moonriver
...
Via Web3Auth SDK, you can interact with [Moonbeam's](https://moonbeam.network/) blockchain to get access to your `account`, fetch `balance`,
