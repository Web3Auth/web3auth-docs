...
image: "/docs/contents/guides/banners/klaytn.png"
...
Via Web3Auth SDK, you can interact with [Klaytn](https://klaytn.foundation) blockchain to get access to your `account`, fetch `balance`,
...
```js
/*
Simply change the chainId feild of `chainConfig` to `0x3e9` (testnet)
*/
