...
**The Web3Auth Web SDK supports all blockchains following the `secp256k1` & `ed25519` curves**. This is because Web3Auth focuses of generating keys
...
const privateKey = provider.request({ method: "private_key" });
