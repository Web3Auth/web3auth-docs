---
title: Integrate Web3Auth with the Ripple Blockchain
sidebar_label: Ripple
image: "content-hub/guides/banners/ripple.png"
displayed_sidebar: docs
keywords: [ripple, web3auth, authentication, blockchain]
description: "Integrate Web3Auth with the Ripple Blockchain | Documentation - Web3Auth"
---
...
The Web3Auth Web SDK offers a standard provider for accessing the user's private key on non-EVM chains like [Ripple](https://ripple.com/). To enable a
...
const adapter = new OpenloginAdapter({
  adapterSettings: {
    provider: xrplProvider, // <-- Injecting the Ripple provider
  },
});
...
const rippleProvider = await web3auth.connect(); // web3auth.provider
```
