...
Create React App (CRA) and Webpack have been **officially deprecated** by React developer team.
Checkout to this [Pull Request](https://github.com/reactjs/react.dev/pull/5487) for more information
about the same.

Although Web3Auth libraries are compatible with CRA, there is a chance certain functionalities might
not work as expected, because of sub dependencies. We recommend using Vite to setup your React app.

Our team has also published a guide to move from CRA to Vite. You can find the guide
[here](https://dev.to/shahbaz17/moving-from-create-react-app-to-vite-for-web3auth-projects-4nce)
