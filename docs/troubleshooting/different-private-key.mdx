...
Refer to the docs [here](/auth-provider-setup/verifiers/aggregate-verifier) to know more about creating an aggregate verifier.
...
To get a client id for your project, please refer [here](/auth-provider-setup/client-id).
