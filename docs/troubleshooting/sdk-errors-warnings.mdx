...
| `NETWORK_RESPONSE_FAILED` | Unable to detect login share from the Auth Network. | This may be due to slow internet connection. Check your internet speed and try again.                                                                      |
...
| `BUSY_NETWORK`            | Unable to connect to Auth Network.                  | The Network may be congested. Please try again in 5 minutes.                                                                                               |
| `KEY_ASSIGN_FAILED`       | A key has not been assigned to you.                 | This might be due to communication with the Auth Network Nodes. Kindly relogin to try again. If problem persists, please Contact Support.                  |
...
<CommonQuestions
  questions={[
    "What are the common SDK errors in Web3Auth?",
    "How do I resolve initialization errors in Web3Auth?",
    "What causes login failures in Web3Auth?",
    "How do I handle JSON RPC errors in Web3Auth?",
    "What are the common Torus Wallet Plugin errors?",
    "How do I troubleshoot Web3Auth Node SDK issues?",
    "What are the infrastructure-related errors in Web3Auth?",
    'How do I fix "Wallet is not found" error?',
    'What should I do when encountering "Invalid Request" errors?',
    "How do I resolve authentication and MFA-related errors?",
  ]}
/>
