...
// Step 6. Configure the JWT Verifier in Web3Auth Dashboard as per the above feilds of JWT.
```
...
See [this](./byo-jwt-providers#filled-custom-jwt-verifier) to setup the customer jwt verifier using the above JWT data on Web3Auth Dashboard.
