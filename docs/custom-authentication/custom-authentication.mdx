...
Federated / Identity providers enable you to use some implicit and authorization code flow logins. You could also use social providers on top of Login
providers to select other Social providers (e.g: Twitter, Apple, GitHub, LinkedIn, WeChat etc.) that are not natively suported by us. This will
require you to register an app with them.

Federated / Identity providers directly supporte through Web3Auth Dashboard:
