...
<CommonQuestions
  questions={[
    "What types of data does Web3Auth collect?",
    "How does Web3Auth process and store user data?",
    "What are my rights regarding my data in Web3Auth?",
    "How can I request deletion of my personal data?",
    "How does Web3Auth handle data privacy and security?",
    "What is Web3Auth's policy on data sharing?",
    "How does Web3Auth handle cookies and tracking?",
    "What are the legal bases for Web3Auth's data processing?",
    "How long does Web3Auth retain user data?",
    "How can I exercise my data protection rights with Web3Auth?",
  ]}
/>
