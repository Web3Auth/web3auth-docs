...
import { safeauthkit, mocaverse, toruswallets } from "@site/src/components/SDKReferenceCards";
...
- **Web3Auth React Native Whitelabelled Wallet:** Deploy a comprehensive mobile solution that ensures a consistent and branded user experience across
  all devices, with the flexibility and performance optimized for mobile users. A live demonstration of this wallet's capabilities and user interface
  can be explored [here](https://www.youtube.com/watch?v=Si8R2IVZHhM), providing insight into its functionality and design.
