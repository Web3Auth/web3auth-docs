...
export const PnPContent = () => (
  <BrowserOnly>
    {() => {
      ...
      return (
        <>
          <h2>Web3Auth Plug and Play Web SDKs</h2>
          <SDKReferenceCards type="pnpweb" />

          <h2>Web3Auth Plug and Play Mobile SDKs</h2>
          <SDKReferenceCards type="pnpmobile" />

          <h2>Web3Auth Plug and Play Gaming SDKs</h2>
          <SDKReferenceCards type="pnpgaming" />
        </>
      );
    }}
