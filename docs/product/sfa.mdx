...
import SFAInfraDark from "@site/static/images/flow-diagrams/sfa-infra-dark.png";
import SFAInfraLight from "@site/static/images/flow-diagrams/sfa-infra-light.png";
...
<CommonQuestions
  questions={[
    "What is Single Factor Auth (SFA) and how does it work?",
    "How does SFA handle wallet generation and key management?",
    "What are the key features of Web3Auth's SFA?",
    "How does SFA maintain security with a 1/1 key share setup?",
    "What authentication methods are supported in SFA?",
    "How does SFA integrate with existing applications?",
    "What platforms are supported by SFA?",
    "How does SFA handle Account Abstraction?",
    "What wallet services are available with SFA?",
    "How does SFA compare to traditional Web3 authentication?",
  ]}
/>
