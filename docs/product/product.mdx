...
<CommonQuestions
  questions={[
    ...
    "How does Web3Auth work with dApps and wallets?",
    "What is the relationship between Web3Auth SDK and integrating applications?",
    "How does Web3Auth handle key management for wallets?",
    "What are the advantages of using Web3Auth for wallet management?",
    "How can dApps benefit from Web3Auth integration?",
    "What authentication flows does Web3Auth support?",
    "How does Web3Auth handle multi-chain support?",
    "Which Web3Auth product should I choose for my wallet?",
    "Which Web3Auth product is best for dApp development?",
  ]}
/>
