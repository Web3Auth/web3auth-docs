    ...
    tiles: [
      {
        ...
        title: "Web",
        icon: "logo-js.png",
        path: "/sdk/web/plugnplay#authenticating-users",
      },
      {
        key: "android",
        title: "Android (Java)",
...
|                     |          | `curve` "secp256k1" (default) or "ed25519" <br/> You can specify which curve you want use for the encoded public key in the login parameters<br/> Refer to the [SDK Reference](/sdk/) |
