...
<img
  style={{ display: "block", maxHeight: "700px", margin: "20px auto" }}
  src={Image2}
  alt="This diagram shows how the keyshares are splitted and stored within different devices and the Auth Network
"
/>
