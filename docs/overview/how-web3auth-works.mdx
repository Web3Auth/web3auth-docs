...
Know more about the key management and security of tkey and our infrastructure [here](./key-management).
...
to note that **Web3Auth is not a wallet, it is wallet infrastructure that is plugged into applications or wallets.**
