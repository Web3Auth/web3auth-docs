...
wallet might the easiest way for you to handle blockchain transactions, it comes with a cost of sacrificing the control of the user flow and trusting
them with the understanding of how to make a blockchain transaction. This also comes with a cost of losing users to the complex terminologies and
flows, which can be easily avoided if you're customising flows according to your needs.
...
1. The dApp owns the whole experience, with minimal external branding. You can even surpass that (have **zero Web3Auth Branding**) if you use
   [Web3Auth Self Host](/self-hosting).
...
[`wallet-connect`](/sdk/web/adapters/wallet-connect-v1), [`torus-wallet-coonector-plugin`](/sdk/web/plugins/torus-wallet), and other Web3Auth
[interoperability](/interoperability) features.
