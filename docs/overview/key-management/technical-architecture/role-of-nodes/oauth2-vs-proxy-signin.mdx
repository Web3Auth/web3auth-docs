...
[standard verifier or 3rd party OAuth2 logins](/overview/key-management/technical-architecture/role-of-nodes/logins-key-assignment) as they depend on
a proxy inbetween the Torus Network and the third party (Google).
