...
- Web3Auth Plug and Play UI SDK [`@web3auth/web3auth`](https://npmjs.com/package/@web3auth/web3auth)
- Web3Auth Plug and Play Core SDK [`@web3auth/core`](https://npmjs.com/package/@web3auth/core)
...
To know and understand how you can use Web3Auth, hop over to [Developing with Web3Auth](../developing-with-web3auth) and get started!

::::

:::info note

- Want to know how our SDKs work? Checkout [Understanding Web3Auth SDKs ](../developing-with-web3auth/understand-sdk)
