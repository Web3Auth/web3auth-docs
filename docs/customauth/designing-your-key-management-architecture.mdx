...
this [list](./supported-authenticators-verifiers). There are some nuances with
...
[aggregating logins](./supported-authenticators-verifiers.mdx#aggregating-logins-verifiers).
