...
- **SSO, passwordless, touch/faceID logins**: Almost all authentication flows are supported, a non comprehensive list can be found [here](supported-authenticators-verifiers)
...
[**Torus Key Infrastructure**](../how-torus-works/technical-architecture) to assign, store
...
[here](/how-torus-works/role-of-torus-nodes/logins-key-assignments-and-retrievals).
