...
import Image2 from "@site/static/content-hub/whitelabel-web3auth-modal-openlogin.png";
...
The Social Logins and Email Login functionalities of Web3Auth operate through the OpenLogin Flow. Additionally, the entire user experience of
OpenLogin can be customized to match your branding using the `OpenLoginAdapter` settings.
