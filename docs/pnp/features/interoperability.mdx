...
import WalletOnDapp from "@site/static/contents/interoperability/interoperability-via-plugin.png";
...
![Torus Wallet](/contents/interoperability/interoperability-torus-wallet.png)
...
- Torus Wallet has two flows to login via Wallet Connect. `Paste` or `Scan` the WalletConnect QR code.
  ...
  - Let say, you want to login to a dApp( eg. OpenSea ), click on WalletConnect option to login, you'll see this screen.
    ...
    ![Wallet Connect QR and copy to clipboard](/contents/interoperability/interoperability-wc-clipboard.png)
  ...
  - Paste the wallet connect url copied above to this box, and click anywhere on the screen. Within seconds, you'll see a green banner saying it's
    ...
    ![Torus Wallet After Paste](/contents/interoperability/interoperability-after-wc-paste.png)
  ...
  - You'll see a Modal to `Accept and Sign`. Click on it and come back to the `Torus Wallet`.
    ...
    ![Modal to Accept and Sign](/contents/interoperability/interoperability-modal-on-opensea.png)

  - In your `Torus Wallet`, you'll need to confirm the permission on the shown Modal.

    ![Confirm Permission Modal](/contents/interoperability/interoperability-confirm-login.png)
  ...
  - To login via QR Code, click on `Scan to connect`.
    ...
    ![Torus Wallet - Scan to Connect](/contents/interoperability/interoperability-torus-wallet.png)
  ...
  - Upon login, you'll see a green banner saying it's connected.
    ...
    ![Torus Wallet After Connected](/contents/interoperability/interoperability-after-wc-paste.png)
