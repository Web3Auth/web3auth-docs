...
One of the most exciting features of Web3Auth is its interoperability with Wallet Connect and Torus Wallet. This means that the private key generated
within your application with Web3Auth can be used to sign transactions within any application using Wallet Connect or Torus Wallet for their login
flow. It enables a dApp to choose if they want to give the user the flexibility of moving funds around without the headache of making the flows
themselves.
...
- [Torus EVM Wallet UI Plugin](/sdk/web/plugins/evm-wallet)
