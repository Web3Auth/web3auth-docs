...
- [Torus EVM Wallet UI Plugin](/sdk/pnp/web/plugins/evm-wallet)
- [Torus Solana Wallet UI Plugin](/sdk/pnp/web/plugins/solana-wallet)

Read more about them in the [Plugins SDK Reference](/sdk/pnp/web/plugins).
