...
From v8, parameters apart from `chainId`, `rpcTarget`, and `chainNamespace` are now optional. Please note, while using
[Wallet Services](/docs/sdk/wallet-services) you have to also pass the optional parameters.
