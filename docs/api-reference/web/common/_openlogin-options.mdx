...
| `no3PC?`                | `boolean`                             | Setting no3PC forces openlogin to assume that third party cookies are blocked in the browser. Only pass no3PC to `true` when you are sure that third party cookies are not supported. By default openlogin will self check third party cookies and proceed accordingly.                                                                                   | No       | `false`       |
