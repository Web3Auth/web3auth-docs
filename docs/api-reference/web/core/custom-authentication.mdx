...
While using the Web3Auth Plug and Play Core SDK, you have the option to use the `connectTo` function, that enables you to customise the login process
according to the parameters you have for your custom authentication service.
