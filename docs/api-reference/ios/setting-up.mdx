...
This tutorial will guide you to use [web3auth-swift-sdk](https://github.com/torusresearch/web3auth-swift-sdk) to integrate Web3Auth into your Android
application.
...
In order to use Web3Auth you need to provide your Web3Auth **Client ID** and which **Network** to run it.
...
| loginConfig | `[String : W3ALoginConfig]` | No        | A configuration optional object to customize login flow. Refer to the Advanced Login Flow section for more info.                              |
