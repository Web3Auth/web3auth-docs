...
- **Web3Auth Service Provider [`@tkey/service-provider-web3auth`](https://www.npmjs.com/package/@tkey/service-provider-web3auth):** Implements
  Web3Auth's Social Login feature as a service provider for providing the **Share B** of the user, using their social login accounts.

- **Web3Auth Storage Layer[`@tkey/storage-layer-torus`](https://www.npmjs.com/package/@tkey/storage-layer-torus):** Gives you the ability to get/set
  the Metadata for the various shares generated.
