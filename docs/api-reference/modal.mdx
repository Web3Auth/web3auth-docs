...
| `custom-auth`      | `WALLET`, `DAPP`  | `EIP155`,`SOLANA` |`NO`        |  `getCustomAuthAdapter`    |
| `torus-evm`        | `DAPP`           | `EIP155`          | `YES`        |  `getTorusEvmAdapter`      |
| `torus-solana`     | `DAPP`              | `SOLANA`          | `YES`        |  `getTorusSolanaAdapter`   |
| `metamask`         | `DAPP`          | `EIP155`          | `YES`        |  `getMetamaskAdapter`      |
| `phantom`          | `DAPP`             | `SOLANA`          | `YES`        |  `getPhantomAdapter`       |
| `seedphrase`       | `WALLET`          | `EIP155`,`SOLANA` | `YES`        |  `getSeedphraseAdapter`    |
| `walletconnect-v1` | `DAPP`            | `EIP155`          | `YES`        |  `getWalletconnectV1Adapter`|
| `walletconnect-v2` (Coming Soon) | `DAPP`           | `MULTICHAIN`      | `NO`         |  `getWalletconnectV2Adapter`|
...
> Note: You cannot change visibility of some required adapters. For ex: Openlogin or CustomAuth
