...
create an instance of the adapter along with the configuration and pass the retruned instance in to `web3auth.configureAdapter` as shown in example below.
