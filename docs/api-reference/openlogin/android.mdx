...
Construct and configure an OpenLoginOptions instance
...
providers to login e.g. Google, Facebook, Twitter, Passwordless, etc. login requires
`LoginParams` as a required input.
Construct and configure a LoginParams instance
