...
import Image9 from "@site/static/contents/whitelabel-web3auth-openlogin-logo-dark.png";
import Image8 from "@site/static/contents/whitelabel-web3auth-openlogin-logo-light.png";
...
<div className="text-image-column">
  <div>
    ...
    <img style={{ display: "block", maxHeight: "500px", alignSelf: "center" }} src={Image5} alt="Standard screen without any change" />
  </div>
  <div>
    <h4>
