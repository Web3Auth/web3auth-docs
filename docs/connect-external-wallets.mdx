...
WalletConnect, Coinbase and more, enabling seemless onboarding of crypto native alongside the social login aspect for non crypto native users. This
...
- [Torus EVM Wallet](/sdk/web/adapters/torus-evm)
- [Torus Solana Wallet](/sdk/web/adapters/torus-solana)
- [MetaMask](/sdk/web/adapters/metamask)
- [Phantom Wallet](/sdk/web/adapters/phantom)
- [WalletConnect V1](/sdk/web/adapters/wallet-connect-v1)
- [Coinbase Wallet](/sdk/web/adapters/coinbase)
- [Slope Wallet](/sdk/web/adapters/slope)
- [Solflare Wallet](/sdk/web/adapters/solflare)
- [Sollet Wallet](/sdk/web/adapters/sollet)
...
available under web3auth as [@web3auth/torus-evm-adapter](/sdk/web/adapters/torus-evm). Every adapter follows a common interface which is required by
...
| ------------------ | ---------------- | ----------------- | ------- | ---------------------------------------------------------------------------- |
| `openlogin`        | `WALLET`, `DAPP` | `EIP155`,`SOLANA` | `YES`   | [`@web3auth/openlogin-adapter`](/sdk/web/openlogin)                          |
| `torus-evm`        | `DAPP`           | `EIP155`          | `YES`   | [`@web3auth/torus-evm-adapter`](/sdk/web/adapters/torus-evm)                 |
| `torus-solana`     | `DAPP`           | `SOLANA`          | `YES`   | [`@web3auth/torus-solana-adapter`](/sdk/web/adapters/torus-solana)           |
| `metamask`         | `DAPP`           | `EIP155`          | `YES`   | [`@web3auth/metamask-adapter`](/sdk/web/adapters/metamask)                   |
| `phantom`          | `DAPP`           | `SOLANA`          | `YES`   | [`@web3auth/phantom-adapter`](/sdk/web/adapters/phantom)                     |
| `walletconnect-v1` | `DAPP`           | `EIP155`          | `YES`   | [`@web3auth/wallet-connect-v1-adapter`](/sdk/web/adapters/wallet-connect-v1) |
| `coinbase`         | `DAPP`           | `EIP155`          | `YES`   | [`@web3auth/coinbase`](/sdk/web/adapters/coinbase)                           |
| `slope`            | `DAPP`           | `SOLANA`          | `YES`   | [`@web3auth/slope`](/sdk/web/adapters/slope)                                 |
| `solflare`         | `DAPP`           | `SOLANA`          | `YES`   | [`@web3auth/solflare`](/sdk/web/adapters/solflare)                           |
| `sollet`           | `DAPP`           | `SOLANA`          | `YES`   | [`@web3auth/sollet`](/sdk/web/adapters/sollet)                               |
...
- External wallet are those which are global for all applications. No matter where you are logging in, you will get same keys if same credentials are
  being provided.
- `metamask`, `phantom` and `walletconnect-v1`, `coinbase`, `slope`, `solflare`, `sollet` are External Wallets in Web3Auth.

:::info

To know more about Adapter, checkout our [SDK Reference](/sdk/web/adapters/#common-configuration-interfaces), where we have specifically mentioned all
