...
![NFT Minting](/images/graphics/nft-minting.svg)
...
<CommonQuestions
  questions={[
    "What is Web3Auth's NFT Minting Service?",
    "How does gasless NFT minting work with Web3Auth?",
    "Which NFT standards does Web3Auth support?",
    "Can I use Web3Auth for NFT airdrops?",
    "Does Web3Auth support both EVM and Solana for NFT minting?",
    "How do I handle fiat payments with NFT minting?",
    "What are webhook notifications in NFT minting?",
    "Does Web3Auth cover gas fees for NFT minting?",
    "How do I access Web3Auth's NFT Services?",
    "Can I implement custom authorization for NFT minting?",
  ]}
/>
