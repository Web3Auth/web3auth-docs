...
<CommonQuestions
  questions={[
    "What is Web3Auth's Account Dashboard?",
    "How do I access the Account Dashboard?",
    "What recovery factors can I manage in the Account Dashboard?",
    "How do I set up Multi-Factor Authentication (MFA)?",
    "Can I manage devices connected to my account?",
    "How do I integrate the Account Dashboard into my dApp?",
    "What security features are available in the Account Dashboard?",
    "How do I backup and recover my account?",
    "Can I add or remove recovery factors?",
    "How do I enhance my account security using the dashboard?",
  ]}
/>
