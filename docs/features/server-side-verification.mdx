...
| `iss`               | `string` | The "iss" (issuer) claim identifies who issued the JWT. (Here, it's Web3Auth `https://api-auth.web3auth.io`)                                                                                                                                                                                                                                               |
...
// use type === web3auth_threshold_key when using useCoreKitKey: true
