...
```json
{
  ...
  "wallets": [
    {
      "public_key": "578970a884b44bbe0cf479d633fe7fa20cfc92dd4ac05eabdb298f4a6413064c", // PnP_Key, when using usePnPKey: true
      "type": "web3auth_app_key",
      "curve": "ed25519"
    },
    {
      "public_key": "218a3a9eb7febe18daa126902080a5a84c3952810d86d6f4d54c283007f2f868", // CoreKit_Key, when using useCoreKitKey: true
...
// use wallets[0].public_key for the PnP_Key and wallets[1].public_key for the CoreKit_Key
