...
<CommonQuestions
  questions={[
    "What is Web3Auth's Custom Authentication feature?",
    "What are the different authentication methods available?",
    "How does Custom Authentication differ from built-in social logins?",
    "What is Grouped Custom Authentication and how does it work?",
    "Why should I choose Custom Authentication over built-in methods?",
    "What types of authentication connections are supported?",
    "How can I migrate existing users to Web3Auth?",
    "How do I integrate my existing authentication system?",
    "What are the benefits of using Custom Authentication?",
    "How do I set up group connections for multiple authentication providers?",
  ]}
/>
