...
- **NFT Checkout Service:** Pre-built, customizable UIs for minting and purchasing NFTs via crypto/
  fiat payments.
- **NFT Minting and Delivery:** Service for facilitating NFT airdrops and situations where you want
...
Through our partnership with PayPal, the Web3Auth SDK can launch a checkout window that guides users
through the complete payment and minting process. Once the transaction is complete, the user's
wallet will contain the minted NFT, and they will be redirected back to your site.
...
The NFT Minting and Delivery API helps you initiate the minting process for specified NFTs, enabling
large-scale, gasless minting through our scalable batch minting infrastructure. This API is perfect
for Airdrops, free mints, or situations where you manage fiat payments independently.
