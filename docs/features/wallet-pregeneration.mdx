...
Web3Auth's Pregenerated Wallets feature simplifies user onboarding by creating wallets for your
users before they log in. This approach enables a smoother Web3 experience, giving developers
flexibility in introducing wallet functionalities to users at the right time.
...
<CommonQuestions
  questions={[
    "What is Web3Auth's Wallet Pregeneration feature?",
    "What are the benefits of using pregenerated wallets?",
    "How do I implement wallet pregeneration in my application?",
    "What are the common use cases for wallet pregeneration?",
    "How does wallet pregeneration improve user onboarding?",
    "What pricing plan is required for wallet pregeneration?",
    "How do I pre-generate smart accounts?",
    "What's the difference between EOA and smart account pregeneration?",
    "How do I handle user identification for pregenerated wallets?",
    "How can I use pregenerated wallets for rewards and incentives?",
  ]}
/>
