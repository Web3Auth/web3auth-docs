...
:::tip Customizing Duration

The duration for which this encrypted state is stored is determined by the
[`sessionTime`](/sdk/pnp/web/modal/initialize#web3authoptions) parameter.
