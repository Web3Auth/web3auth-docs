...
<CommonQuestions
  questions={[
    "How do I connect external wallets with Web3Auth?",
    "What is Wallet Discovery and how does it work?",
    "Which external wallets are supported by Web3Auth?",
    "How does Multi Injected Provider Discovery (EIP6963) work?",
    "Can I use Web3Auth with Solana wallets?",
    "How do I integrate Web3Auth with Wagmi?",
    "What is the web3auth-wagmi-connector?",
    "Can I use Web3Auth with RainbowKit or ConnectKit?",
    "How does WalletConnect integration work with Web3Auth?",
    "What are the different ways to configure external wallets?",
  ]}
/>
