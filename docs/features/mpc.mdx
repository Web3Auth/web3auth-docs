...
[pricing plan](https://web3auth.io/pricing.html) to use this feature is the **Enterprise Plan**.
...
read through [How Web3Auth Works](/docs/how-web3auth-works/) and
[Wallet Management and Security of our Infrastructure](/docs/infrastructure/).
