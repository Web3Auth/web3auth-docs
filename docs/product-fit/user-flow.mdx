...
[`@web3auth/single-factor-auth`](/sdk/web/single-factor-auth/) and [`@web3auth/node-sdk`](/sdk/node/) help you directly achieve this flow as well.
...
- [Web3Auth Plug and Play No Modal SDK](/sdk/web/no-modal/multi-factor-authentication)
