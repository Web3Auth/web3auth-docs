...
This package provides main class for using default web3auth modal.
...
After you are done with configuring your adapters, you can call show modal by calling `initModal` function of `web3auth`.
