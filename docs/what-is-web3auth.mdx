...
other key management methods, Web3Auth results in a standard **cryptographic key provider specific to the user and application**. To experience it for yourself check out some [examples](/usecases) or our [dashboard itself](https://dashboard.web3auth.io).
...
Understanding and storing seed phrases take new users take anywhere from 10-15 minutes before any meaningful interaction with an app/wallet. Moreso quantifiably [losses are rapmant](https://finance.yahoo.com/news/4-2-billion-lost-bitcoin-154948781.html#:~:text=Approximately%2020%25%20of%20all%20Bitcoins,billion%2C%20a%20new%20study%20says.) in the crypto space with the incumbant standard of seed phrases. Provide an alternative, with Web3Auth's social logins that
leverage on existing accounts and user devices to secure their key.
...
<div class="image-todo" style={{"flex-basis":"300px", "flex-grow": "1", "text-align": "center" }} >
