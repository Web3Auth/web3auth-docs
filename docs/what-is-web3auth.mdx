...
<CommonQuestions
  questions={[
    "What exactly is Web3Auth and how does it help with Web3 integration?",
    "Is Web3Auth a cryptocurrency wallet?",
    "What authentication methods does Web3Auth support?",
    "How secure is Web3Auth for storing digital assets?",
    "How long does it take for users to get started with Web3Auth?",
    "Can Web3Auth handle large-scale applications with millions of users?",
    "What platforms and technologies does Web3Auth support?",
    "How does Web3Auth make Web3 more accessible to non-technical users?",
    "What security measures does Web3Auth use to protect user assets?",
    "Can I integrate Web3Auth with my existing authentication system?",
  ]}
/>
