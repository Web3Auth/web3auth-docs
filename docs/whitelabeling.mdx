...
<div class="text-image-column">
  ...
  <div>
    <img style={{ minWidth: "250px", maxWidth: "300px" }} src="/contents/whitelabel-web3auth-modal-openlogin.png" />
  </div>
</div>
...
<div class="text-image-column">
  ...
  <div>
    <img style={{ width: "100%", maxWidth: "500px" }} src="/contents/whitelabel-web3auth-openlogin-language.png" />
  </div>
</div>
<br />
