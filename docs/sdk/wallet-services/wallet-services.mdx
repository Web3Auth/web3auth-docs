...
:::info Minimum SCALE plan required

The minimum [pricing plan](https://web3auth.io/pricing.html) to use this SDK in a production environment is the **SCALE Plan**. You can use this
feature in the development environment for free.

**Wallet Services currently supports EVM chains only.**
