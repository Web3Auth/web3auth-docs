...
description: "Pregenerate Wallets API | Documentation - Web3Auth"
---
...
export default function LookupAPIPage() {
    ...
    return (
        <>
            <h1>Pregenerate Wallet API</h1>
            <p>The Pregenerate Wallets API allows you to create user wallets using just an email or social account, bypassing traditional signup. Users can claim these wallets later, simplifying the onboarding process.</p>
