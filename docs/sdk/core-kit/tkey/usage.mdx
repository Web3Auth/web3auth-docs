...
If you prefer using an implicit login method with your OAuth Provider, you can do so by using the `TorusServiceProvider`. You can check out the
...
[Providers Section](/sdk/providers/).
