...
- [**Storage Modules**](#storage-modules-share-b): Storage Modules are used to store Shares B in the user's device storage.
- [**Recovery Modules**](#recovery-modules-share-c): Recovery Modules are used to recover the Shares C and so, in the case user doesn't have access to
  their device/storage or needs additional security.
- [**Additional Modules**](#additional-modules): These modules provide extra capability to the tKey SDK, like importing users' existing private keys
  or seed phrases.
