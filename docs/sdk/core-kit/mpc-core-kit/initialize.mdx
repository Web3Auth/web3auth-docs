...
| `tssLib`                  | The threshold signing library to use. For secp256k1 keyType, you can use the `@toruslabs/tss-dkls-lib`, and for ed25519 keyType you can use `@toruslabs/tss-frost-lib`.                                                                                                                                                                                                                                             |
