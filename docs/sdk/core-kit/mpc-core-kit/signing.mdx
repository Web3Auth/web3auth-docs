...
As discussed earlier, to generate the ECSDA signature for Ethereum, we will utilize
...
[EthereumSigningProvider documentation](/docs/sdk/providers/evm-mpc#sign-a-message).
...
// Returns the ECSDA signature bytes.
