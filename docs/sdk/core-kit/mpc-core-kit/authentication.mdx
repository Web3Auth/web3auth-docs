...
| `importTssKey?`          | Key to import key into TSS during first time login. For SEC1 curve, you can pass the private key, and for ed25519 curve you can pass the seed. |
