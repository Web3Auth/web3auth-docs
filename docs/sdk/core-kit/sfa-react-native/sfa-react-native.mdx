...
common use cases, the Web3Auth Plug and Play React Native SDK allows you to redirect users to a Web3Auth-hosted screen (`https://auth.web3auth.io`).
...
- [Quick Start](/quick-start?product=CORE_KIT&sdk=SFA_REACT_NATIVE&framework=IOS&stepIndex=0): Integrate Web3Auth in 4 Simple Steps.
...
- [Community Support Portal](https://web3auth.io/community/c/help-core-kit/sfa-react-native-sdk/32): Join our community to get support from our team
