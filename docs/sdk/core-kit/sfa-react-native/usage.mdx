...
- `getChainId()` - Get chainId from the web3auth instance.
...
You can find the updated examples [here](/examples?product=Core+Kit&sdk=Single+Factor+Auth+React+Native+SDK).
