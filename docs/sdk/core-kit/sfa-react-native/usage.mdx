...
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| `chainNamespace` | <ul><li>**`string`** - (Choose between `eip155`, `solana` & `other`)</li> **or** <li>**`ChainNamespaceType`** - (Choose between `CHAIN_NAMESPACES.EIP155`, `CHAIN_NAMESPACES.SOLANA` & `CHAIN_NAMESPACES.OTHER`)</li></ul> | The namespace of your preferred chain. Checkout [Providers SDK Reference](/sdk/providers) for understanding RPC Calls.                                                                                                                               | No       |
