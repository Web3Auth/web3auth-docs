...
| `network`            | `TORUS_NETWORK_TYPE` | Auth Network to target options: mainnet, testnet, aqua, celeste & cyan.                                                                                                                                                                                                         | `mainnet`     | No        |
...
export interface CustomAuthArgs {
  ...
  metadataUrl?: string;
  /**
   * Auth Network to target options: mainnet | testnet | cyan | celeste | aqua
