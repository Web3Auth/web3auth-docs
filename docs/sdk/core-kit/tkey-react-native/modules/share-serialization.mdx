---
title: Share Serialization Module - tKey React Native SDK
sidebar_label: Share Serialization
displayed_sidebar: sdk
description: "Web3Auth Core Kit tKey React Native SDK - Modules -  Share Serialization | Documentation - Web3Auth"
---
