...
The Web3Auth [Single Factor Auth Android SDK](https://github.com/Web3Auth/single-factor-auth-java) is a client & server side library you can use with
your Android app to authenticate users using Web3Auth. For natively using the One Key flow of Web3Auth in Android, Web3Auth provides an SFA Android
SDK written in _Java_, which helps you implement the Web3Auth without redirection in a single key pair flow.
...
- [Source Code](https://github.com/Web3Auth/single-factor-auth-java): Web3Auth is open sourced. You can find the source code on our GitHub repository.
