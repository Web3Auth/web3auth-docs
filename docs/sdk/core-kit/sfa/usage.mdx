---
title: "Usage of Single Factor Auth SDK"
sidebar_label: "Usage"
displayed_sidebar: sdk
description: "Usage of Single Factor Auth SDK | Documentation - Web3Auth"
---
...
Follow this [guide](/content-hub/guides/single-factor-auth) for ideal flow using a combination of Web3Auth Single Factor Auth SDK and Web3Auth Core SDK.
