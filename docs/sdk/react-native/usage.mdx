...
Web3Auth returns the following functions: login() - Logs in the User using the particular configuration you require for authentication. logout() -
Logs out the User.
...
web3auth.login({
  ...
  //highlight-start
  extraLoginOptions: {
    domain: "example.com", // domain of your app backend or any random string
