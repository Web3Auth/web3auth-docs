...
In order to configure your service provider, you must use [CustomAuth Swift SDK](https://github.com/torusresearch/customauth-swift-sdk). Since
CustomAuth Swift SDK is not automatically installed when you install tkey ios SDK, let's start with installation first.
