...
The Session Management feature allows you to check the existing sessions with Web3Auth. The sessions will allow users to remain authenticated with
Web3Auth for up to 1 day default, or a maximum of 7 days, or until they logout or session data is cleared.
