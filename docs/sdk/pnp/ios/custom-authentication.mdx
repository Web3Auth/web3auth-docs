...
public enum TypeOfLogin: String, Codable { case google case facebook case reddit case discord case
twitch case apple case github case linkedin case twitter case weibo case line case email_password
case passwordless case jwt }
...
let web3Auth = try await Web3Auth( W3AInitParams( clientId: "YOUR_CLIENT_ID", network:
.sapphire_mainnet, // focus-start loginConfig: [ Web3AuthProvider.JWT.rawValue: .init(
verifier: "YOUR_VERIFIER_NAME", // Get it from web3auth dashboard typeOfLogin: TypeOfLogin.facebook,
clientId: "YOUR_FACEBOOK_CLIENT_ID", ) ] // focus-end ) )
