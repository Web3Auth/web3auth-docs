...
| `whiteLabel`     | [W3AWhiteLabelData](/sdk/pnp/ios/whitelabel) | No        | A configuration optional object to customize UI, branding, and translations for your brand. Refer to the WhiteLabeling section for more info. |
