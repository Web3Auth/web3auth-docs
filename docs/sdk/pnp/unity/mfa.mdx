  ...
  void Start()
  {
    ...
    web3Auth.setOptions(new Web3AuthOptions()
    {
      ...
      mfaSettings = new MfaSettings(
        deviceShareFactor = new MfaSetting(true, 1, false),
        backUpShareFactor = new MfaSetting(true, 1, true),
        socialBackupFactor = new MfaSetting(true, 1, false),
        passwordFactor = new MfaSetting(true, 1, true)
      )
    });
