...
Instance, Whitelabeling and Custom Authentication have to be configured within this step.
...
in-depth about providers, have a look at your [Providers reference](/sdk/pnp/web/providers).
