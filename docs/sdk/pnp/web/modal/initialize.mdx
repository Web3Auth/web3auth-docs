...
::: note It's mandatory to provide `privateKeyProvider` for your corresponding chain namespace. To know more in-depth about providers, have a look at
your [Providers reference](/sdk/helper-sdks/providers). :::
