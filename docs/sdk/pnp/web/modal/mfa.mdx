...
Social logins in Web3Auth are enabled by the [`auth-adapter`](/sdk/pnp/web/adapters/auth).
...
Checkout the [`auth-adapter`](/sdk/pnp/web/adapters/auth) SDK Reference for more details
