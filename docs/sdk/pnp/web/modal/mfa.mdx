...
import OpenloginAdapterSettings from "@site/src/common/sdk/pnp/web/_auth-adapter-settings.mdx";
import OpenloginLoginSettings from "@site/src/common/sdk/pnp/web/_auth-login-settings.mdx";
...
Social logins in Web3Auth are enabled by the [`openlogin-adapter`](/sdk/pnp/web/adapters/auth).
