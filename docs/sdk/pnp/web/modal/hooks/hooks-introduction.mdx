...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| `isConnected`        | Indicates if a user is currently connected.                                                                                     |
| `provider`           | The current provider, or `null` if not connected.                                                                               |
| `userInfo`           | Information about the connected user.                                                                                           |
| `isMFAEnabled`       | Indicates if Multi-Factor Authentication (MFA) is enabled.                                                                      |
| `isInitialized`      | Indicates if Web3Auth has been initialized.                                                                                     |
| `status`             | The current status of the Web3Auth adapter.                                                                                     |
...
| `authenticateUser`   | Authenticates the connected user. Returns a Promise of `UserAuthInfo`.                                                          |
...
interface IBaseWeb3AuthHookContext {
  /**
   * Indicates if a user is currently connected.
   */
  isConnected: boolean;
  /**
  ...
  /**
   * Indicates if Multi-Factor Authentication (MFA) is enabled.
   */
  isMFAEnabled: boolean;
  /**
   * Indicates if Web3Auth has been initialized.
   */
  ...
  /**
   * Authenticates the connected user.
