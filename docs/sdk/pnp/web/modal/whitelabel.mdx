...
- [**Openlogin Adapter**](#openlogin-adapter): The redirect screens while logging in and constructing the key, can be customised according to your
  pcommon as well. For this you need to pass on the `whiteLabel` configuration parameter to the [`openlogin-adapter`](/sdk/pnp/web/openlogin).
...
[`openlogin-adapter`](/sdk/pnp/web/openlogin).
...
Read more about Initializing the Torus EVM Wallet Plugin in the [Torus Wallet Connector Plugin SDK Reference](/sdk/pnp/web/plugins/evm-wallet)
