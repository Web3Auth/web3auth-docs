...
- [**Auth Adapter**](#auth-adapter): The redirect screens while logging in and constructing the
  key, can be customised according to your common as well. For this, you need to pass on the
  `whiteLabel` configuration parameter to the [`auth-adapter`](/sdk/pnp/web/adapters/auth).
