...
| `walletconnect-v1`      | `DAPP`           | `EIP155`          | `NO`    | [`@web3auth/wallet-connect-v1-adapter`](/sdk/pnp/web/adapters/wallet-connect-v1) |
| `coinbase`              | `DAPP`           | `EIP155`          | `NO`    | [`@web3auth/coinbase`](/sdk/pnp/web/adapters/coinbase)                           |
| `slope`                 | `DAPP`           | `SOLANA`          | `NO`    | [`@web3auth/slope`](/sdk/pnp/web/adapters/slope)                                 |
| `solflare`              | `DAPP`           | `SOLANA`          | `NO`    | [`@web3auth/solflare`](/sdk/pnp/web/adapters/solflare)                           |
| `default-evm-adapter`   | `DAPP`           | `EIP155`          | `NO`    | [`@web3auth/default-evm-adapter`](/sdk/pnp/web/adapter/default-evm-adapter)      |
| `default-solana-adapter`| `DAPP`           | `SOLANA`          | `NO`    | [`@web3auth/default-solana-adapter`](/sdk/pnp/web/adapter/default-solana-adapter)|
