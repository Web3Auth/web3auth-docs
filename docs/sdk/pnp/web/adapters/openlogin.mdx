...
certain configurations set to enable a quick integration, however, for customizing features, like [Whitelabel](/features/whitelabel),
[Custom Authentication](/features/custom-authentication), etc. you need to configure the Openlogin Adapter. With the Openlogin Adapter package
