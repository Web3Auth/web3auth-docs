...
`getDefaultExternalAdapters` function. It provides an option to use the WalletConnect v2 wallet
list. In case if the wallet is not installed, user can use the WalletConnect to connect.
