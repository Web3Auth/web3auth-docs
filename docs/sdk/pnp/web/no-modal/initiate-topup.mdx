...
For topping up the wallet of a user, you can use the `initiateTopup()` function. This method takes
in the parameters of the selected payment provider and accordingly gives you the option to
seamlessly add money to your user's wallet address directly.
