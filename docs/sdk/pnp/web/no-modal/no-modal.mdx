...
doesn't contain the UI Modal as compared to the [`@web3auth/modal`](/sdk/pnp/web/modal) package, the size of this package is smaller.
...
- [Quick Start](/quick-start?product=PNP&sdk=PNP_NO_MODAL&framework=REACT&stepIndex=0): Get Started with an easy to follow integration of Web3Auth
...
- [Community Support Portal](https://web3auth.io/community/c/help-pnp/pnp-no-modal/15): Join our community to get support from our team and other
  developers.
