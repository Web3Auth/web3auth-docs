...
- [Default Provider for all other Blockchains](/sdk/helper-sdks/providers/other)
...
[`@web3auth/openlogin-adapter`](/sdk/pnp/web/adapters/openlogin). For the rest of the external wallets, every adapter follows a common interface which
