...
- [Default Provider for all other Blockchains](/sdk/pnp/web/providers/other)
...
- [`@web3auth/torus-wallet-connector-plugin`](/sdk/pnp/web/plugins/evm-wallet)
- [`@web3auth/solana-wallet-connector-plugin`](/sdk/pnp/web/plugins/solana-wallet)
...
[`@web3auth/openlogin-adapter`](/sdk/pnp/web/openlogin). For the rest of the external wallets, every adapter follows a common interface which is
...
- [`@web3auth/openlogin-adapter`](/sdk/pnp/web/openlogin) _**- default** (Enables social logins)_
