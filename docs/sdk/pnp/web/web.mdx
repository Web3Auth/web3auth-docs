...
the default [`@web3auth/openlogin-adapter`](/sdk/pnp/web/adapters/auth) for social logins. For the
rest of the external wallets, every adapter follows a common interface which is required by Web3Auth
...
- [`@web3auth/openlogin-adapter`](/sdk/pnp/web/adapters/auth) _**- default** (Enables social
  logins)_
