...
Checkout the [Modal](https://github.com/Web3Auth/web3auth-pnp-examples/tree/main/web-modal-sdk/wagmi/) &
[No Modal](https://github.com/Web3Auth/web3auth-pnp-examples/tree/main/web-no-modal-sdk/wagmi/) Example Apps to see how wagmi works with Web3Auth.
