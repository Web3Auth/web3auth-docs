...
| -------------------- | ------------ | --------- | ---------------------------------- |
| `deviceShareFactor`  | `MfaSetting` | No        | MFA setting for deviceShareFactor  |
| `backUpShareFactor`  | `MfaSetting` | No        | MFA setting for backUpShareFactor  |
| `socialBackupFactor` | `MfaSetting` | No        | MFA setting for socialBackupFactor |
| `passwordFactor`     | `MfaSetting` | No        | MFA setting for passwordFactor     |
