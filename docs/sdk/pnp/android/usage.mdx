...
| [getEd25519Key](#ed25519-private-key)           | Retrieve the user's ed25519 key. The key can be used to sign transactions for chains using the ed25519 curve like Solana, Near, Algorand, and others. |
...
The method can be used to sign transactions for any EVM chain and screens can be whitelabeled to
your branding.
