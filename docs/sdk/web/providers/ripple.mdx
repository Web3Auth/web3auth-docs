---
title: Ripple Provider
displayed_sidebar: sdk
description: "Ripple Provider | Documentation - Web3Auth"
---

---

The `@web3auth/xrpl-provider` is a Web3Auth provider that simplifies interaction with the Ripple Blockchain by serving as a wrapper around the
[Ripple JSON RPC API](https://xrpl.org/request-formatting.html). It is used to interact with the Ripple blockchain and perform various operations like
