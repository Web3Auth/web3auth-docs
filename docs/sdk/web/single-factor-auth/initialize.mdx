---
title: "Initialize Single Factor Auth SDK"
sidebar_label: "Initialize"
displayed_sidebar: sdk
description: "Initialize Single Factor Auth SDK | Documentation - Web3Auth"
---
...
#### Import the `Web3Auth` class from `@web3auth/single-factor-auth`
