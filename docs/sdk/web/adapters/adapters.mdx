...
| ------------------ | ---------------- | ----------------- | ------- | ------------------------------------------------------------ |
| `openlogin`        | `WALLET`, `DAPP` | `EIP155`,`SOLANA` | `YES`   | [`@web3auth/openlogin-adapter`](../openlogin)                |
| `torus-evm`        | `DAPP`           | `EIP155`          | `YES`   | [`@web3auth/torus-evm-adapter`](./torus-evm)                 |
| `torus-solana`     | `DAPP`           | `SOLANA`          | `YES`   | [`@web3auth/torus-solana-adapter`](./torus-solana)           |
| `metamask`         | `DAPP`           | `EIP155`          | `YES`   | [`@web3auth/metamask-adapter`](./metamask)                   |
| `phantom`          | `DAPP`           | `SOLANA`          | `YES`   | [`@web3auth/phantom-adapter`](./phantom)                     |
| `walletconnect-v1` | `DAPP`           | `EIP155`          | `YES`   | [`@web3auth/wallet-connect-v1-adapter`](./wallet-connect-v1) |
| `coinbase`         | `DAPP`           | `EIP155`          | `YES`   | [`@web3auth/coinbase`](./coinbase)                           |
| `slope`            | `DAPP`           | `SOLANA`          | `YES`   | [`@web3auth/slope`](./slope)                                 |
| `solflare`         | `DAPP`           | `SOLANA`          | `YES`   | [`@web3auth/solflare`](./solflare)                           |
| `sollet`           | `DAPP`           | `SOLANA`          | `YES`   | [`@web3auth/sollet`](./sollet)                               |
