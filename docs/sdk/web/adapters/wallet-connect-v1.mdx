...
Wallet Connect V1 is going to be depricated, please use [**Wallet Connect v2 Adapter**](./wallet-connect-v2).
...
[here](https://docs.walletconnect.com/2.0/advanced/migrating-from-v1.0).
