...
sidebar_label: Openlogin Adapter
displayed_sidebar: sdk
description: "Openlogin Adapter Package for Social Logins | Documentation - Web3Auth"
---
...
Read more about how to pass `loginParams` to `connectTo` in its respective section: [`web3auth/no-modal`](/sdk/web/no-modal/usage#logging-in-the-user)
