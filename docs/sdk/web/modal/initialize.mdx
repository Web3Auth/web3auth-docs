---
title: Initialize Plug n Play Modal
...
with Web3Auth Plug and Play Modal SDK, have a look at our [Whitelabeling SDK Reference](/sdk/web/modal/whitelabel).
...
modal UI supports a set of default adapters depending on the [`authMode`](/sdk/web/modal/initialize#web3authoptions) being used.
