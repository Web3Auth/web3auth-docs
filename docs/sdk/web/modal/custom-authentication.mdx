...
`@web3auth/modal`, ie. the Plug and Play UI SDK, the `loginConfig` should be corresponding to the socials mentioned in the modal. This means you can
...
Since we're using the `@web3auth/modal` ie. the Plug and Play UI SDK, the `loginConfig` should be corresponding to the socials mentioned in the modal.
Here, we're customising Google and Facebook to be custom verified, rest all other socials will be default.
