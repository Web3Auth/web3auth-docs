---
title: Whitelabel Plug n Play UI
...
import PluginConfig from "@site/src/common/sdk/web/_plugin-config.mdx";
import PluginWhitelabelConfig from "@site/src/common/sdk/web/_plugin-whitelabel-config.mdx";
...
- [**Openlogin Adapter**](#openlogin-adapter): The redirect screens while logging in and constructing the key, can be customised according to your
  pcommon as well. For this you need to pass on the `whiteLabel` configuration parameter to the [`openlogin-adapter`](/sdk/web/openlogin).
...
Read more about Instantiating Web3Auth in the [Initialization SDK Reference](/sdk/web/web3auth/initialize#instantiating-web3auth)
...
Read more about Initializing Web3Auth Modal in the [Initialization SDK Reference](/sdk/web/web3auth/initialize#initializing-modal)
...
[`openlogin-adapter`](/sdk/web/openlogin).
...
Read more about Initializing the Torus EVM Wallet Plugin in the [Torus Wallet Connector Plugin SDK Reference](/sdk/web/plugins/torus-wallet)
