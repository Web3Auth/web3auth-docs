...
Read more about Instantiating Web3Auth in the [Initialization SDK Reference](/sdk/web/modal/initialize#instantiating-web3auth)
...
Read more about Initializing Web3Auth Modal in the [Initialization SDK Reference](/sdk/web/modal/initialize#initializing-modal)
