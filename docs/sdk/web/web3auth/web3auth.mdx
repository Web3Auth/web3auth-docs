...
Web3Auth within your interface. Additionally, it is a child class of [`@web3auth/core`](/sdk/web/core) package. Hence, you can still call all the functions
available in the [`@web3auth/core`](/sdk/web/core) package.
