...
import InitModalConfigExample from "../common/_init-modal-config-example.mdx";
import ModalConfig from "../common/_modal-config.mdx";
...
import UIConfig from "../common/_ui-config.mdx";
import UIConfigWhitelabelExample from "../common/_ui-config-whitelabel-example.mdx";
...
Read more about Instantiating Web3Auth in the [Initialization SDK Reference](./initialize#instantiating-web3auth)
...
Read more about Initializing Web3Auth Modal in the [Initialization SDK Reference](./initialize#initializing-modal)
