...
Learn more about how to use [Torus EVM Wallet Plugin](/sdk/web/plugins/torus-wallet).
...
Learn more about how to use [Torus Solana Wallet Plugin](/sdk/web/plugins/solana-wallet).
