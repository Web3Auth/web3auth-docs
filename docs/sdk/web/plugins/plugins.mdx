...
#### [`@web3auth/torus-wallet-connector-plugin`](./torus-wallet)
...
Learn more about how to use [Torus EVM Wallet Plugin](./torus-wallet).

### Torus Solana Wallet UI Plugin

---

#### [`@web3auth/solana-wallet-connector-plugin`](./solana-wallet)
...
Learn more about how to use [Torus Solana Wallet Plugin](./solana-wallet).
