...
[Torus Solana Wallet documentation](https://docs.tor.us/solana-wallet/sdk/class#init)
...
#### Know more about how to use the [Torus Solana Wallet Instance and provider](https://docs.tor.us/solana-wallet/sdk/solana/send-transaction)
