...
Once you have set up Wagmi using the Web3Auth Modal SDK (see the [Setup guide](#wagmi-integration)),
you can use all Wagmi composables directly in your application—no additional wrappers or
configuration are needed beyond the initial setup.
