...
| -------------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| `loginProvider?`     | `LOGIN_PROVIDER_TYPE` or `CUSTOM_LOGIN_PROVIDER_TYPE` | Sets the oauth login method to be used. You can use any of the valid loginProvider from the supported list. If this param is not passed then it will show all the available login methods to user in a modal. <br /><br /> The list of available options: `google`, `facebook`, `reddit`, `discord`, `twitch`, `apple`, `line`, `github`, `kakao`, `linkedin`, `twitter`, `weibo`, `wechat`, `email_passwordless`, `webauthn`, `jwt`                                                                                                                                                          | No       |
