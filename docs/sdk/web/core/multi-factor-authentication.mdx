...
While you can pass your `mfaLevel` to `OpenloginAdapter`, it is not required for the Web3Auth Plug and Play Core package, since you can directly pass
...
Social logins in Web3Auth are enabled by the [`openlogin-adapter`](/sdk/web/openlogin). Natively, it is already present and preconfigured within the Plug
