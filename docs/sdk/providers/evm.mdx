---
title: EIP1193 (EVM) Private Key Provider
...
If you are using `chainNamespace: "eip155"` while initializing `Web3Auth` or `Web3AuthNoModal` with
...
the EthereumPrivateKeyProvider.
