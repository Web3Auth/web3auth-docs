...
[**repository**](https://github.com/Web3Auth/wallet-ecosystems-examples/tree/main/safeauth-embed/safe-react-example) for an end-to-end **Web3Auth**
and **SafeAuth Kit integration**.
