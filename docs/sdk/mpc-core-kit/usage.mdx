...
<<<<<<< HEAD:docs/sdk/core-kit/mpc-core-kit/usage.mdx Check out the
[Authentication](/sdk/core-kit/mpc-core-kit/authentication) section of the SDK Reference to learn
more about these functions. ======= Check out the
[**Authentication**](/sdk/mpc-core-kit/authentication) section of the SDK Reference to learn more
about these functions.

> > > > > > > ef71bb68 (restructure mpc core kit):docs/sdk/mpc-core-kit/usage.mdx
