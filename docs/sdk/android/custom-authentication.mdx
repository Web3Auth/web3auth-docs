...
Check out how to create a **[Custom Verifier](/docs/custom-authentication/verifiers)** on the Web3Auth Dashboard.
...
web3Auth = Web3Auth (
  Web3AuthOptions (
    ...
    loginConfig = hashMapOf("jwt" to LoginConfigItem(
      ...
      typeOfLogin = TypeOfLogin.JWT,
      name = "Custom JWT Login",
      clientId = getString (R.string.web3auth_client_id) // web3auth's client id,
    ))
    // highlight-end
  )
)
