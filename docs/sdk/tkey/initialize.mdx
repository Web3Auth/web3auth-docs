---
title: "Initialize Web3Auth Core Kit tKey SDK"
sidebar_label: "Initialize"
displayed_sidebar: sdk
description: "Core Kit tKey SDK - Initialisation  | Documentation - Web3Auth"
---

import InitParams from "@site/src/common/sdk/tKey/_init-params.mdx";
import ModulesDescription from "@site/src/common/sdk/tKey/_modules-description.mdx";
import ModulesExample from "@site/src/common/sdk/tKey/_modules-example.mdx";
import ServiceProviderArg from "@site/src/common/sdk/tKey/_service-provider-arg.mdx";
import ServiceProviderExample from "@site/src/common/sdk/tKey/_service-provider-example.mdx";
import TKeyArgs from "@site/src/common/sdk/tKey/_tkey-args.mdx";
import TKeyInstanceExample from "@site/src/common/sdk/tKey/_tkey-instance-example.mdx";
...
Service Provider in `tKey` is used for generating a [**Share A**](/sdk/tkey), i.e. the private key share managed by a wallet service provider via
their authentication flows. This share in our [key infrastructure](/infrastructure/key-management/) refers to the social login aspect, where we
