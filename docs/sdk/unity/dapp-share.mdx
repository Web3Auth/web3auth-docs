---
title: Using dApp Share in Unity SDK
sidebar_label: dApp Share
displayed_sidebar: sdk
description: "Unity SDK - dApp Share | Documentation - Web3Auth"
---
...
The user experience in gaming & native OS platforms is very different from the web platforms. This is because the user has to be redirected to a
...
authentication. Whereas in web platforms, `Share B` is stored in the browser context. We can still store it in the browser context for other devices,
