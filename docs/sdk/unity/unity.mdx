...
Web3Auth on Unity3D game engine. This SDK has been written majorly in _C#_ and can be integrated across all desktop, web and mobile platforms. It
...
Get started with a sample app code, found within the SDK package after installing. You can also find it
[here](https://github.com/Web3Auth/web3auth-unity-sdk/tree/master/Assets/Plugins/Web3AuthSDK/Sample).
