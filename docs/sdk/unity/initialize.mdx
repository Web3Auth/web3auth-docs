...
| `network`     | enum Web3Auth.Network                 | Yes       | Network to run Web3Auth, either MAINNET, TESTNET or CYAN                                                                                           |
...
class Web3AuthOptions {
  ...
  public Web3Auth.Network network;    // Network to run Web3Auth, either MAINNET, TESTNET or CYAN
