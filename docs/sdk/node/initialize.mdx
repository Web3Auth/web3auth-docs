...
description: "Initialize Node.js SDK | Documentation - Web3Auth"
---
...
This is done by calling `init()` function of the `web3auth` instance we created above with a network type matching the verifer's network. **_Default
