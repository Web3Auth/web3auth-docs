...
Web3Auth's `@web3auth/node-sdk` backend SDK is a simple and easy to use SDK to be used in your Node.js backend to get the same experience of Web3Auth
frontend SDKs. One thing to note here is that, with this you get semi-custodiality.
...
// Available {network: "testnet", "mainnet", "cyan", "aqua"}
```
...
await web3auth.connect({
  verifier: "verifier-name", // verifier has to match the network passed in init().
