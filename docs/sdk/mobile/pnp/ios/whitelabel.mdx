...
From version `9.0.0`, Web3Auth iOS Plug and Play SDK offers whitelabeling capabilities via the
...
optional object called `W3AWhiteLabelData`. `W3AWhiteLabelData` can be definied during
initialization of the SDK in `W3AInitParams` object.
