...
<CommonQuestions
  questions={[
    "What are the system requirements for using Web3Auth Flutter SDK?",
    "How do I install Web3Auth in a Flutter project?",
    "What Android configurations are needed for Web3Auth Flutter SDK?",
    "How do I update the Android compileSdkVersion for Web3Auth?",
    "What permissions are required for Android implementation?",
    "How do I configure deep linking in Android for Web3Auth?",
    "What are the iOS platform requirements for Web3Auth Flutter SDK?",
    "How do I configure redirection in iOS for Web3Auth?",
    "What Gradle configurations are needed for Android?",
