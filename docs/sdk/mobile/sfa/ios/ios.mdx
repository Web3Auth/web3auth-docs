---
title: "Web3Auth Single Factor Auth Swift SDK"
sidebar_label: Overview
description: "Web3Auth Single Factor Auth Swift SDK | Documentation - Web3Auth"
---
...
Swift SDK, which allows you to use Web3Auth SFA Swift and prevent redirection to Auth Service hosted
screens.
...
- [Source Code](https://github.com/Web3Auth/single-factor-auth-swift): Web3Auth is open sourced. You
  can find the source code on our GitHub repository.

- [Community Support Portal](https://web3auth.io/community/c/help-core-kit/sfa-ios-sdk/30): Join our
  community to get support from our team and other developers.

<CommonQuestions
  questions={[
    "What is Web3Auth's Single Factor Auth Swift SDK and what does it do?",
    "How is SFA Swift SDK different from Plug and Play iOS SDK?",
    "What are the system requirements for using Web3Auth SFA with iOS?",
    "What pricing plan is required for using iOS SFA in production?",
    "How does the One Key flow work in Swift SFA SDK?",
    "How do I handle authentication without redirection in iOS?",
    "Which Apple platforms are supported by Web3Auth SFA?",
    "Where can I find example iOS applications using Web3Auth SFA?",
    "Is Web3Auth's Swift SFA SDK open source?",
    "Where can I get support for Web3Auth iOS SFA implementation?",
  ]}
/>
