...
Future<void> initPlatformState() async {
  ...
  await Web3AuthFlutter.init(Web3AuthOptions(
    ...
    loginConfig: Map("google" to LoginConfigItem)(
...
Future<void> initPlatformState() async {
  ...
  await Web3AuthFlutter.init(Web3AuthOptions(
    ...
    loginConfig: Map("facebook" to LoginConfigItem)(
      verifier: "verifier-name", // get it from web3auth dashboard
...
final Web3AuthResponse response = await Web3AuthFlutter.login(LoginParams(loginProvider: Provider.facebook));
```
