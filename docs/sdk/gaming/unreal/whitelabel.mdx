...
additional parameter within the `Web3AuthOptions` class called `whiteLabel`. This parameter takes
...
![Unreal Whitelabel](/images/unreal/unreal-whitelable-data.png)
