...
- [EthereumPrivateKeyProvider](/sdk/web/providers/evm#getting-a-provider-from-any-secp256k1-private-key): For Ethereum and EVM compatible chains
  (secp256k1 private key)
- [SolanaPrivateKeyProvider](/sdk/web/providers/solana#getting-a-provider-from-any-ed25519-private-key): For Solana Blockchain (ed25519 private key)
