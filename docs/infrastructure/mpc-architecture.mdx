...
This document provides an in-depth exploration of the technical architecture of the MPC-based SDKs, this includes the tKey MPC SDK and CoreKit MPC SDK
(a rundown of our SDKs [here](/how-web3auth-works/)).
...
Web3Auth uses tKey MPC to manage user wallets in a distributed fashion, leveraging various factors or shares managed by users, including their
devices, private inputs, backup locations, and cloud service providers. As long as a user can access 2 out of n (2/n) of these shares, they can access
...
signature session. The threshold signature session consists of an offline signing phase and an online signing phase (GG20, GG19, Doerner19).
