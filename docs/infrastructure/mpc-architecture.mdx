...
description: "MPC Architecture - Web3Auth Key Infrastructure | Documentation - Web3Auth"
---
...
This document provides an in-depth exploration of the technical architecture of the MPC-based SDKs, this includes the tKey MPC SDK and CoreKit MPC SDK (a rundown of our SDKs [here](/how-web3auth-works/)).

The only difference between the SSS-based SDKs and MPC SDKs are that during usage/login MPC SDKs do not reconstruct user keys.

While the tKey MPC SDK, supports multiple configurations like 2/n, 2/2 flows, this documentation, for simplicity,
...
Web3Auth uses [tKey MPC](https://github.com/tkey) to manage user keys in a distributed fashion, leveraging various factors or shares managed by users,
...
they can access their key. This distributedly secure key is called the $TSSKey$.
...
<img style={{ display: "block", margin: "20px auto" }} src={TKeyMPCFlow} alt="Web3Auth Wallet Management" />
