...
description: "OAuth2.0 vs Proxy(Federated) Signin | Documentation - Web3Auth"
---

Proxy verifiers differ from a
[standard verifier or 3rd party OAuth2 logins](/infrastructure/technical-architecture/role-of-nodes/logins-key-assignment) as they depend on a proxy
...
![End-to-end flow that occurs with Torus Login complemented with Auth0 as a proxy.](/content-hub/sign-in-with-auth0-1-.png)
