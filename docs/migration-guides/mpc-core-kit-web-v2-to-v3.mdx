...
Based on the `tssLib`, the `keyType` will be defined for the `Web3AuthMPCCoreKit` instance. For
generating ECDSA signature, you should use
[@toruslabs/tss-dkls-lib](https://www.npmjs.com/package/@toruslabs/tss-dkls-lib), and for generating
EdDSA signature you should use
