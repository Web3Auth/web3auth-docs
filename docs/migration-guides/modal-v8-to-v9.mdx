...
Starting with v9, external wallet adapters for Metamask, Phantom, and Solflare are deprecated in
favor of the Default EVM Adapter and Default Solana Adapter. These new adapters use MIPD to
automatically detect injected wallets.

#### Metmask Adapter Migration
...
const web3AuthContextConfig: Web3AuthContextConfig = {
  ...
  // add-end
  adapters: [openloginAdapter, metamask!],
