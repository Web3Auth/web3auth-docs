...
## Benefits of Web3Auth MFA

- Self-Custodial Security: Key shares remain under user control without reliance on a centralized
  entity.
- Cross-Device Recovery: Users can regain access to their accounts even if they switch devices.
- Flexible Implementation: Developers can choose the right balance between security and UX by tuning
  MFA behavior and available factors.
