...
2. Paste the following as a Redirect URI into the "OAuth Redirect URLs" field.
   ...
   ![Twitch OAuth2.0 App Dashboard](/images/social-providers/twitch/twitch-app.png)

3. After creation of your Twitch app, click **Manage**

   ![Twitch OAuth2.0 App Manage](/images/social-providers/twitch/twitch-manage.png)

4. Obtain the **Client ID**

   ![Twitch OAuth2.0 App Manage](/images/social-providers/twitch/twitch-client-id.png)
