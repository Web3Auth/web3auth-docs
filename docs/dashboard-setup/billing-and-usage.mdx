...
<div style={{ flexBasis: "300px", flexGrow: "1", textAlign: "center" }}>
  <img
    ...
    style={{ alignSelf: "center", maxWidth: "100%" }}
    alt="Dashboard Billing Payment Details and Invoice History"
  />
</div>
...
<div style={{ flexBasis: "300px", flexGrow: "1", textAlign: "center" }}>
  <img
    src={DashboardBillingEditCard}
    style={{ alignSelf: "center", maxWidth: "100%" }}
    alt="Dashboard Billing Edit Card"
  />
</div>
